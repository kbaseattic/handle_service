package Bio::KBase::AbstractHandle::Client;
...
Bio::KBase::AbstractHandle::Client
...
sub new
{
    ...
    my $self = {
	client => Bio::KBase::AbstractHandle::Client::RpcClient->new,
	url => $url,
	headers => [],
    };
...
sub _validate_version {
    ...
    if ($sMinor > $cMinor) {
        warn "New client version available for Bio::KBase::AbstractHandle::Client\n";
    }
    if ($sMajor == 0) {
        warn "Bio::KBase::AbstractHandle::Client version is $svr_version. API subject to change.\n";
    }
}
...
package Bio::KBase::AbstractHandle::Client::RpcClient;
