package Bio::KBase::AbstractHandle::AbstractHandleServer;
...
our %method_authentication = (
        'new_handle' => 'optional',
        'localize_handle' => 'none',
        'initialize_handle' => 'optional',
        'persist_handle' => 'optional',
        'upload' => 'optional',
        'download' => 'optional',
        'upload_metadata' => 'optional',
        'download_metadata' => 'optional',
        'hids_to_handles' => 'none',
        'are_readable' => 'required',
        'is_owner' => 'required',
        'is_readable' => 'required',
        'list_handles' => 'optional',
        'delete_handles' => 'optional',
        'give' => 'required',
        'ids_to_handles' => 'required',
);
...
sub call_method {
    ...
    my $ctx = AbstractHandleServerContext->new($self->{loggers}->{userlog},
...
{
    # Service AbstractHandle requires authentication.
	...
	{
	    $self->exception('PerlError', "Authentication required for AbstractHandle but no authentication header was passed");
	}
    ...
    my @result;
    {
        ...
        my $stderr = AbstractHandleServerStderrWrapper->new($ctx, $get_time);
        $ctx->stderr($stderr);
...
sub get_method
{
    ...
    {
	$self->exception('NoSuchMethod',
			 "'$method' is not a valid method in service AbstractHandle.");
    }
...
package AbstractHandleServerContext;

use strict;

=head1 NAME

AbstractHandleServerContext
...
package AbstractHandleServerStderrWrapper;
...
unless (caller) {
    ...
    my $server = AbstractHandleServer->new(
