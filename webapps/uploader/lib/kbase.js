...
function json_call_ajax_sync(_url, method, params)
{
...
function json_call_ajax_async(_url, method, params, num_rets, callback, error_callback)
{
	var rpc = { 'params' : params,
				'method' : method,
				'version': "1.1",
	...
	var x = jQuery.ajax({"async": true,
						 ...
						 error: function(xhr, textStatus, errorThrown) {
						     if (xhr.responseText) {
							     ...
							     error_callback({"xhr": xhr, "textStatus": textStatus, "errorThrown": errorThrown});
							 }
							 else {
							     throw Error({"xhr": xhr, "textStatus": textStatus, "errorThrown": errorThrown});
							 }
						 },
						 data: body,
						 processData: false,
...
function CDMI_API(url) {
    ...
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.fids_to_annotations", [fids]);
//	var resp = json_call_sync("CDMI_API.fids_to_annotations", [fids]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.fids_to_annotations", [fids], 1, _callback, _error_callback)
    }

    this.fids_to_functions = function(fids)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.fids_to_functions", [fids]);
//	var resp = json_call_sync("CDMI_API.fids_to_functions", [fids]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.fids_to_functions", [fids], 1, _callback, _error_callback)
    }

    this.fids_to_literature = function(fids)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.fids_to_literature", [fids]);
//	var resp = json_call_sync("CDMI_API.fids_to_literature", [fids]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.fids_to_literature", [fids], 1, _callback, _error_callback)
    }

    this.fids_to_protein_families = function(fids)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.fids_to_protein_families", [fids]);
//	var resp = json_call_sync("CDMI_API.fids_to_protein_families", [fids]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.fids_to_protein_families", [fids], 1, _callback, _error_callback)
    }

    this.fids_to_roles = function(fids)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.fids_to_roles", [fids]);
//	var resp = json_call_sync("CDMI_API.fids_to_roles", [fids]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.fids_to_roles", [fids], 1, _callback, _error_callback)
    }

    this.fids_to_subsystems = function(fids)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.fids_to_subsystems", [fids]);
//	var resp = json_call_sync("CDMI_API.fids_to_subsystems", [fids]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.fids_to_subsystems", [fids], 1, _callback, _error_callback)
    }

    this.fids_to_co_occurring_fids = function(fids)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.fids_to_co_occurring_fids", [fids]);
//	var resp = json_call_sync("CDMI_API.fids_to_co_occurring_fids", [fids]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.fids_to_co_occurring_fids", [fids], 1, _callback, _error_callback)
    }

    this.fids_to_locations = function(fids)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.fids_to_locations", [fids]);
//	var resp = json_call_sync("CDMI_API.fids_to_locations", [fids]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.fids_to_locations", [fids], 1, _callback, _error_callback)
    }

    this.locations_to_fids = function(region_of_dna_strings)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.locations_to_fids", [region_of_dna_strings]);
//	var resp = json_call_sync("CDMI_API.locations_to_fids", [region_of_dna_strings]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.locations_to_fids", [region_of_dna_strings], 1, _callback, _error_callback)
    }

    this.alleles_to_bp_locs = function(alleles)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.alleles_to_bp_locs", [alleles]);
//	var resp = json_call_sync("CDMI_API.alleles_to_bp_locs", [alleles]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.alleles_to_bp_locs", [alleles], 1, _callback, _error_callback)
    }

    this.region_to_fids = function(region_of_dna)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.region_to_fids", [region_of_dna]);
//	var resp = json_call_sync("CDMI_API.region_to_fids", [region_of_dna]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.region_to_fids", [region_of_dna], 1, _callback, _error_callback)
    }

    this.region_to_alleles = function(region_of_dna)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.region_to_alleles", [region_of_dna]);
//	var resp = json_call_sync("CDMI_API.region_to_alleles", [region_of_dna]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.region_to_alleles", [region_of_dna], 1, _callback, _error_callback)
    }

    this.alleles_to_traits = function(alleles)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.alleles_to_traits", [alleles]);
//	var resp = json_call_sync("CDMI_API.alleles_to_traits", [alleles]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.alleles_to_traits", [alleles], 1, _callback, _error_callback)
    }

    this.traits_to_alleles = function(traits)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.traits_to_alleles", [traits]);
//	var resp = json_call_sync("CDMI_API.traits_to_alleles", [traits]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.traits_to_alleles", [traits], 1, _callback, _error_callback)
    }

    this.ous_with_trait = function(genome, trait, measurement_type, min_value, max_value)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.ous_with_trait", [genome, trait, measurement_type, min_value, max_value]);
//	var resp = json_call_sync("CDMI_API.ous_with_trait", [genome, trait, measurement_type, min_value, max_value]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.ous_with_trait", [genome, trait, measurement_type, min_value, max_value], 1, _callback, _error_callback)
    }

    this.locations_to_dna_sequences = function(locations)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.locations_to_dna_sequences", [locations]);
//	var resp = json_call_sync("CDMI_API.locations_to_dna_sequences", [locations]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.locations_to_dna_sequences", [locations], 1, _callback, _error_callback)
    }

    this.proteins_to_fids = function(proteins)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.proteins_to_fids", [proteins]);
//	var resp = json_call_sync("CDMI_API.proteins_to_fids", [proteins]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.proteins_to_fids", [proteins], 1, _callback, _error_callback)
    }

    this.proteins_to_protein_families = function(proteins)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.proteins_to_protein_families", [proteins]);
//	var resp = json_call_sync("CDMI_API.proteins_to_protein_families", [proteins]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.proteins_to_protein_families", [proteins], 1, _callback, _error_callback)
    }

    this.proteins_to_literature = function(proteins)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.proteins_to_literature", [proteins]);
//	var resp = json_call_sync("CDMI_API.proteins_to_literature", [proteins]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.proteins_to_literature", [proteins], 1, _callback, _error_callback)
    }

    this.proteins_to_functions = function(proteins)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.proteins_to_functions", [proteins]);
//	var resp = json_call_sync("CDMI_API.proteins_to_functions", [proteins]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.proteins_to_functions", [proteins], 1, _callback, _error_callback)
    }

    this.proteins_to_roles = function(proteins)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.proteins_to_roles", [proteins]);
//	var resp = json_call_sync("CDMI_API.proteins_to_roles", [proteins]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.proteins_to_roles", [proteins], 1, _callback, _error_callback)
    }

    this.roles_to_proteins = function(roles)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.roles_to_proteins", [roles]);
//	var resp = json_call_sync("CDMI_API.roles_to_proteins", [roles]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.roles_to_proteins", [roles], 1, _callback, _error_callback)
    }

    this.roles_to_subsystems = function(roles)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.roles_to_subsystems", [roles]);
//	var resp = json_call_sync("CDMI_API.roles_to_subsystems", [roles]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.roles_to_subsystems", [roles], 1, _callback, _error_callback)
    }

    this.roles_to_protein_families = function(roles)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.roles_to_protein_families", [roles]);
//	var resp = json_call_sync("CDMI_API.roles_to_protein_families", [roles]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.roles_to_protein_families", [roles], 1, _callback, _error_callback)
    }

    this.fids_to_coexpressed_fids = function(fids)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.fids_to_coexpressed_fids", [fids]);
//	var resp = json_call_sync("CDMI_API.fids_to_coexpressed_fids", [fids]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.fids_to_coexpressed_fids", [fids], 1, _callback, _error_callback)
    }

    this.protein_families_to_fids = function(protein_families)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.protein_families_to_fids", [protein_families]);
//	var resp = json_call_sync("CDMI_API.protein_families_to_fids", [protein_families]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.protein_families_to_fids", [protein_families], 1, _callback, _error_callback)
    }

    this.protein_families_to_proteins = function(protein_families)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.protein_families_to_proteins", [protein_families]);
//	var resp = json_call_sync("CDMI_API.protein_families_to_proteins", [protein_families]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.protein_families_to_proteins", [protein_families], 1, _callback, _error_callback)
    }

    this.protein_families_to_functions = function(protein_families)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.protein_families_to_functions", [protein_families]);
//	var resp = json_call_sync("CDMI_API.protein_families_to_functions", [protein_families]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.protein_families_to_functions", [protein_families], 1, _callback, _error_callback)
    }

    this.protein_families_to_co_occurring_families = function(protein_families)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.protein_families_to_co_occurring_families", [protein_families]);
//	var resp = json_call_sync("CDMI_API.protein_families_to_co_occurring_families", [protein_families]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.protein_families_to_co_occurring_families", [protein_families], 1, _callback, _error_callback)
    }

    this.co_occurrence_evidence = function(pairs_of_fids)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.co_occurrence_evidence", [pairs_of_fids]);
//	var resp = json_call_sync("CDMI_API.co_occurrence_evidence", [pairs_of_fids]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.co_occurrence_evidence", [pairs_of_fids], 1, _callback, _error_callback)
    }

    this.contigs_to_sequences = function(contigs)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.contigs_to_sequences", [contigs]);
//	var resp = json_call_sync("CDMI_API.contigs_to_sequences", [contigs]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.contigs_to_sequences", [contigs], 1, _callback, _error_callback)
    }

    this.contigs_to_lengths = function(contigs)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.contigs_to_lengths", [contigs]);
//	var resp = json_call_sync("CDMI_API.contigs_to_lengths", [contigs]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.contigs_to_lengths", [contigs], 1, _callback, _error_callback)
    }

    this.contigs_to_md5s = function(contigs)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.contigs_to_md5s", [contigs]);
//	var resp = json_call_sync("CDMI_API.contigs_to_md5s", [contigs]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.contigs_to_md5s", [contigs], 1, _callback, _error_callback)
    }

    this.md5s_to_genomes = function(md5s)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.md5s_to_genomes", [md5s]);
//	var resp = json_call_sync("CDMI_API.md5s_to_genomes", [md5s]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.md5s_to_genomes", [md5s], 1, _callback, _error_callback)
    }

    this.genomes_to_md5s = function(genomes)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.genomes_to_md5s", [genomes]);
//	var resp = json_call_sync("CDMI_API.genomes_to_md5s", [genomes]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.genomes_to_md5s", [genomes], 1, _callback, _error_callback)
    }

    this.genomes_to_contigs = function(genomes)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.genomes_to_contigs", [genomes]);
//	var resp = json_call_sync("CDMI_API.genomes_to_contigs", [genomes]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.genomes_to_contigs", [genomes], 1, _callback, _error_callback)
    }

    this.genomes_to_fids = function(genomes, types_of_fids)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.genomes_to_fids", [genomes, types_of_fids]);
//	var resp = json_call_sync("CDMI_API.genomes_to_fids", [genomes, types_of_fids]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.genomes_to_fids", [genomes, types_of_fids], 1, _callback, _error_callback)
    }

    this.genomes_to_taxonomies = function(genomes)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.genomes_to_taxonomies", [genomes]);
//	var resp = json_call_sync("CDMI_API.genomes_to_taxonomies", [genomes]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.genomes_to_taxonomies", [genomes], 1, _callback, _error_callback)
    }

    this.genomes_to_subsystems = function(genomes)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.genomes_to_subsystems", [genomes]);
//	var resp = json_call_sync("CDMI_API.genomes_to_subsystems", [genomes]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.genomes_to_subsystems", [genomes], 1, _callback, _error_callback)
    }

    this.subsystems_to_genomes = function(subsystems)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.subsystems_to_genomes", [subsystems]);
//	var resp = json_call_sync("CDMI_API.subsystems_to_genomes", [subsystems]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.subsystems_to_genomes", [subsystems], 1, _callback, _error_callback)
    }

    this.subsystems_to_fids = function(subsystems, genomes)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.subsystems_to_fids", [subsystems, genomes]);
//	var resp = json_call_sync("CDMI_API.subsystems_to_fids", [subsystems, genomes]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.subsystems_to_fids", [subsystems, genomes], 1, _callback, _error_callback)
    }

    this.subsystems_to_roles = function(subsystems, aux)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.subsystems_to_roles", [subsystems, aux]);
//	var resp = json_call_sync("CDMI_API.subsystems_to_roles", [subsystems, aux]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.subsystems_to_roles", [subsystems, aux], 1, _callback, _error_callback)
    }

    this.subsystems_to_spreadsheets = function(subsystems, genomes)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.subsystems_to_spreadsheets", [subsystems, genomes]);
//	var resp = json_call_sync("CDMI_API.subsystems_to_spreadsheets", [subsystems, genomes]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.subsystems_to_spreadsheets", [subsystems, genomes], 1, _callback, _error_callback)
    }

    this.all_roles_used_in_models = function()
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.all_roles_used_in_models", []);
//	var resp = json_call_sync("CDMI_API.all_roles_used_in_models", []);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.all_roles_used_in_models", [], 1, _callback, _error_callback)
    }

    this.complexes_to_complex_data = function(complexes)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.complexes_to_complex_data", [complexes]);
//	var resp = json_call_sync("CDMI_API.complexes_to_complex_data", [complexes]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.complexes_to_complex_data", [complexes], 1, _callback, _error_callback)
    }

    this.genomes_to_genome_data = function(genomes)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.genomes_to_genome_data", [genomes]);
//	var resp = json_call_sync("CDMI_API.genomes_to_genome_data", [genomes]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.genomes_to_genome_data", [genomes], 1, _callback, _error_callback)
    }

    this.fids_to_regulon_data = function(fids)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.fids_to_regulon_data", [fids]);
//	var resp = json_call_sync("CDMI_API.fids_to_regulon_data", [fids]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.fids_to_regulon_data", [fids], 1, _callback, _error_callback)
    }

    this.regulons_to_fids = function(regulons)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.regulons_to_fids", [regulons]);
//	var resp = json_call_sync("CDMI_API.regulons_to_fids", [regulons]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.regulons_to_fids", [regulons], 1, _callback, _error_callback)
    }

    this.fids_to_feature_data = function(fids)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.fids_to_feature_data", [fids]);
//	var resp = json_call_sync("CDMI_API.fids_to_feature_data", [fids]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.fids_to_feature_data", [fids], 1, _callback, _error_callback)
    }

    this.equiv_sequence_assertions = function(proteins)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.equiv_sequence_assertions", [proteins]);
//	var resp = json_call_sync("CDMI_API.equiv_sequence_assertions", [proteins]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.equiv_sequence_assertions", [proteins], 1, _callback, _error_callback)
    }

    this.fids_to_atomic_regulons = function(fids)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.fids_to_atomic_regulons", [fids]);
//	var resp = json_call_sync("CDMI_API.fids_to_atomic_regulons", [fids]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.fids_to_atomic_regulons", [fids], 1, _callback, _error_callback)
    }

    this.atomic_regulons_to_fids = function(atomic_regulons)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.atomic_regulons_to_fids", [atomic_regulons]);
//	var resp = json_call_sync("CDMI_API.atomic_regulons_to_fids", [atomic_regulons]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.atomic_regulons_to_fids", [atomic_regulons], 1, _callback, _error_callback)
    }

    this.fids_to_protein_sequences = function(fids)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.fids_to_protein_sequences", [fids]);
//	var resp = json_call_sync("CDMI_API.fids_to_protein_sequences", [fids]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.fids_to_protein_sequences", [fids], 1, _callback, _error_callback)
    }

    this.fids_to_proteins = function(fids)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.fids_to_proteins", [fids]);
//	var resp = json_call_sync("CDMI_API.fids_to_proteins", [fids]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.fids_to_proteins", [fids], 1, _callback, _error_callback)
    }

    this.fids_to_dna_sequences = function(fids)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.fids_to_dna_sequences", [fids]);
//	var resp = json_call_sync("CDMI_API.fids_to_dna_sequences", [fids]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.fids_to_dna_sequences", [fids], 1, _callback, _error_callback)
    }

    this.roles_to_fids = function(roles, genomes)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.roles_to_fids", [roles, genomes]);
//	var resp = json_call_sync("CDMI_API.roles_to_fids", [roles, genomes]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.roles_to_fids", [roles, genomes], 1, _callback, _error_callback)
    }

    this.reactions_to_complexes = function(reactions)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.reactions_to_complexes", [reactions]);
//	var resp = json_call_sync("CDMI_API.reactions_to_complexes", [reactions]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.reactions_to_complexes", [reactions], 1, _callback, _error_callback)
    }

    this.aliases_to_fids = function(aliases)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.aliases_to_fids", [aliases]);
//	var resp = json_call_sync("CDMI_API.aliases_to_fids", [aliases]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.aliases_to_fids", [aliases], 1, _callback, _error_callback)
    }

    this.external_ids_to_fids = function(external_ids, prefix_match)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.external_ids_to_fids", [external_ids, prefix_match]);
//	var resp = json_call_sync("CDMI_API.external_ids_to_fids", [external_ids, prefix_match]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.external_ids_to_fids", [external_ids, prefix_match], 1, _callback, _error_callback)
    }

    this.reaction_strings = function(reactions, name_parameter)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.reaction_strings", [reactions, name_parameter]);
//	var resp = json_call_sync("CDMI_API.reaction_strings", [reactions, name_parameter]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.reaction_strings", [reactions, name_parameter], 1, _callback, _error_callback)
    }

    this.roles_to_complexes = function(roles)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.roles_to_complexes", [roles]);
//	var resp = json_call_sync("CDMI_API.roles_to_complexes", [roles]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.roles_to_complexes", [roles], 1, _callback, _error_callback)
    }

    this.complexes_to_roles = function(complexes)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.complexes_to_roles", [complexes]);
//	var resp = json_call_sync("CDMI_API.complexes_to_roles", [complexes]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.complexes_to_roles", [complexes], 1, _callback, _error_callback)
    }

    this.fids_to_subsystem_data = function(fids)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.fids_to_subsystem_data", [fids]);
//	var resp = json_call_sync("CDMI_API.fids_to_subsystem_data", [fids]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.fids_to_subsystem_data", [fids], 1, _callback, _error_callback)
    }

    this.representative = function(genomes)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.representative", [genomes]);
//	var resp = json_call_sync("CDMI_API.representative", [genomes]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.representative", [genomes], 1, _callback, _error_callback)
    }

    this.otu_members = function(genomes)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.otu_members", [genomes]);
//	var resp = json_call_sync("CDMI_API.otu_members", [genomes]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.otu_members", [genomes], 1, _callback, _error_callback)
    }

    this.otus_to_representatives = function(otus)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.otus_to_representatives", [otus]);
//	var resp = json_call_sync("CDMI_API.otus_to_representatives", [otus]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.otus_to_representatives", [otus], 1, _callback, _error_callback)
    }

    this.fids_to_genomes = function(fids)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.fids_to_genomes", [fids]);
//	var resp = json_call_sync("CDMI_API.fids_to_genomes", [fids]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.fids_to_genomes", [fids], 1, _callback, _error_callback)
    }

    this.text_search = function(input, start, count, entities)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.text_search", [input, start, count, entities]);
//	var resp = json_call_sync("CDMI_API.text_search", [input, start, count, entities]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.text_search", [input, start, count, entities], 1, _callback, _error_callback)
    }

    this.corresponds = function(fids, genome)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.corresponds", [fids, genome]);
//	var resp = json_call_sync("CDMI_API.corresponds", [fids, genome]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.corresponds", [fids, genome], 1, _callback, _error_callback)
    }

    this.corresponds_from_sequences = function(g1_sequences, g1_locations, g2_sequences, g2_locations)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.corresponds_from_sequences", [g1_sequences, g1_locations, g2_sequences, g2_locations]);
//	var resp = json_call_sync("CDMI_API.corresponds_from_sequences", [g1_sequences, g1_locations, g2_sequences, g2_locations]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.corresponds_from_sequences", [g1_sequences, g1_locations, g2_sequences, g2_locations], 1, _callback, _error_callback)
    }

    this.close_genomes = function(seq_set, n)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.close_genomes", [seq_set, n]);
//	var resp = json_call_sync("CDMI_API.close_genomes", [seq_set, n]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.close_genomes", [seq_set, n], 1, _callback, _error_callback)
    }

    this.representative_sequences = function(seq_set, rep_seq_parms)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.representative_sequences", [seq_set, rep_seq_parms]);
//	var resp = json_call_sync("CDMI_API.representative_sequences", [seq_set, rep_seq_parms]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.representative_sequences", [seq_set, rep_seq_parms], 2, _callback, _error_callback)
    }

    this.align_sequences = function(seq_set, align_seq_parms)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.align_sequences", [seq_set, align_seq_parms]);
//	var resp = json_call_sync("CDMI_API.align_sequences", [seq_set, align_seq_parms]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.align_sequences", [seq_set, align_seq_parms], 1, _callback, _error_callback)
    }

    this.build_tree = function(alignment, build_tree_parms)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.build_tree", [alignment, build_tree_parms]);
//	var resp = json_call_sync("CDMI_API.build_tree", [alignment, build_tree_parms]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.build_tree", [alignment, build_tree_parms], 1, _callback, _error_callback)
    }

    this.alignment_by_id = function(aln_id)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.alignment_by_id", [aln_id]);
//	var resp = json_call_sync("CDMI_API.alignment_by_id", [aln_id]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.alignment_by_id", [aln_id], 1, _callback, _error_callback)
    }

    this.tree_by_id = function(tree_id)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.tree_by_id", [tree_id]);
//	var resp = json_call_sync("CDMI_API.tree_by_id", [tree_id]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.tree_by_id", [tree_id], 1, _callback, _error_callback)
    }
}
...
function CDMI_EntityAPI(url) {
    ...
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Alignment", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Alignment", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Alignment", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_Alignment = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_Alignment", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_Alignment", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_Alignment", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Alignment = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Alignment", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Alignment", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Alignment", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_AlignmentAttribute = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_AlignmentAttribute", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_AlignmentAttribute", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_AlignmentAttribute", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_AlignmentAttribute = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_AlignmentAttribute", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_AlignmentAttribute", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_AlignmentAttribute", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_AlignmentAttribute = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_AlignmentAttribute", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_AlignmentAttribute", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_AlignmentAttribute", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_AlignmentRow = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_AlignmentRow", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_AlignmentRow", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_AlignmentRow", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_AlignmentRow = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_AlignmentRow", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_AlignmentRow", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_AlignmentRow", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_AlignmentRow = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_AlignmentRow", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_AlignmentRow", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_AlignmentRow", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_AlleleFrequency = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_AlleleFrequency", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_AlleleFrequency", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_AlleleFrequency", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_AlleleFrequency = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_AlleleFrequency", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_AlleleFrequency", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_AlleleFrequency", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_AlleleFrequency = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_AlleleFrequency", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_AlleleFrequency", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_AlleleFrequency", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Annotation = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Annotation", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Annotation", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Annotation", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_Annotation = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_Annotation", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_Annotation", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_Annotation", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Annotation = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Annotation", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Annotation", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Annotation", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Assay = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Assay", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Assay", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Assay", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_Assay = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_Assay", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_Assay", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_Assay", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Assay = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Assay", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Assay", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Assay", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_AtomicRegulon = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_AtomicRegulon", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_AtomicRegulon", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_AtomicRegulon", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_AtomicRegulon = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_AtomicRegulon", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_AtomicRegulon", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_AtomicRegulon", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_AtomicRegulon = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_AtomicRegulon", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_AtomicRegulon", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_AtomicRegulon", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Attribute = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Attribute", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Attribute", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Attribute", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_Attribute = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_Attribute", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_Attribute", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_Attribute", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Attribute = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Attribute", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Attribute", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Attribute", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Biomass = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Biomass", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Biomass", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Biomass", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_Biomass = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_Biomass", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_Biomass", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_Biomass", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Biomass = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Biomass", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Biomass", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Biomass", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_CodonUsage = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_CodonUsage", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_CodonUsage", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_CodonUsage", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_CodonUsage = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_CodonUsage", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_CodonUsage", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_CodonUsage", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_CodonUsage = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_CodonUsage", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_CodonUsage", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_CodonUsage", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Complex = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Complex", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Complex", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Complex", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_Complex = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_Complex", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_Complex", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_Complex", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Complex = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Complex", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Complex", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Complex", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Compound = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Compound", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Compound", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Compound", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_Compound = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_Compound", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_Compound", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_Compound", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Compound = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Compound", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Compound", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Compound", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_CompoundInstance = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_CompoundInstance", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_CompoundInstance", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_CompoundInstance", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_CompoundInstance = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_CompoundInstance", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_CompoundInstance", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_CompoundInstance", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_CompoundInstance = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_CompoundInstance", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_CompoundInstance", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_CompoundInstance", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Contig = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Contig", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Contig", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Contig", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_Contig = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_Contig", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_Contig", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_Contig", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Contig = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Contig", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Contig", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Contig", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_ContigChunk = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_ContigChunk", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_ContigChunk", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_ContigChunk", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_ContigChunk = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_ContigChunk", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_ContigChunk", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_ContigChunk", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_ContigChunk = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_ContigChunk", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_ContigChunk", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_ContigChunk", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_ContigSequence = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_ContigSequence", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_ContigSequence", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_ContigSequence", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_ContigSequence = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_ContigSequence", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_ContigSequence", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_ContigSequence", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_ContigSequence = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_ContigSequence", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_ContigSequence", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_ContigSequence", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_CoregulatedSet = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_CoregulatedSet", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_CoregulatedSet", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_CoregulatedSet", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_CoregulatedSet = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_CoregulatedSet", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_CoregulatedSet", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_CoregulatedSet", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_CoregulatedSet = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_CoregulatedSet", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_CoregulatedSet", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_CoregulatedSet", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Diagram = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Diagram", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Diagram", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Diagram", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_Diagram = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_Diagram", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_Diagram", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_Diagram", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Diagram = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Diagram", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Diagram", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Diagram", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_EcNumber = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_EcNumber", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_EcNumber", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_EcNumber", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_EcNumber = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_EcNumber", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_EcNumber", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_EcNumber", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_EcNumber = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_EcNumber", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_EcNumber", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_EcNumber", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Environment = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Environment", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Environment", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Environment", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_Environment = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_Environment", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_Environment", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_Environment", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Environment = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Environment", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Environment", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Environment", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Experiment = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Experiment", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Experiment", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Experiment", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_Experiment = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_Experiment", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_Experiment", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_Experiment", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Experiment = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Experiment", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Experiment", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Experiment", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_ExperimentalUnit = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_ExperimentalUnit", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_ExperimentalUnit", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_ExperimentalUnit", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_ExperimentalUnit = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_ExperimentalUnit", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_ExperimentalUnit", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_ExperimentalUnit", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_ExperimentalUnit = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_ExperimentalUnit", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_ExperimentalUnit", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_ExperimentalUnit", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Family = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Family", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Family", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Family", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_Family = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_Family", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_Family", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_Family", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Family = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Family", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Family", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Family", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Feature = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Feature", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Feature", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Feature", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_Feature = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_Feature", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_Feature", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_Feature", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Feature = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Feature", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Feature", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Feature", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Genome = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Genome", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Genome", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Genome", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_Genome = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_Genome", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_Genome", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_Genome", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Genome = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Genome", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Genome", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Genome", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Locality = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Locality", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Locality", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Locality", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_Locality = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_Locality", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_Locality", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_Locality", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Locality = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Locality", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Locality", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Locality", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_LocalizedCompound = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_LocalizedCompound", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_LocalizedCompound", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_LocalizedCompound", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_LocalizedCompound = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_LocalizedCompound", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_LocalizedCompound", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_LocalizedCompound", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_LocalizedCompound = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_LocalizedCompound", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_LocalizedCompound", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_LocalizedCompound", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Location = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Location", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Location", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Location", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_Location = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_Location", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_Location", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_Location", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Location = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Location", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Location", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Location", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_LocationInstance = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_LocationInstance", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_LocationInstance", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_LocationInstance", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_LocationInstance = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_LocationInstance", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_LocationInstance", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_LocationInstance", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_LocationInstance = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_LocationInstance", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_LocationInstance", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_LocationInstance", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Measurement = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Measurement", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Measurement", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Measurement", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_Measurement = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_Measurement", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_Measurement", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_Measurement", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Measurement = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Measurement", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Measurement", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Measurement", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Media = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Media", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Media", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Media", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_Media = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_Media", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_Media", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_Media", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Media = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Media", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Media", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Media", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Model = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Model", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Model", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Model", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_Model = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_Model", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_Model", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_Model", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Model = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Model", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Model", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Model", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_OTU = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_OTU", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_OTU", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_OTU", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_OTU = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_OTU", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_OTU", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_OTU", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_OTU = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_OTU", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_OTU", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_OTU", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_ObservationalUnit = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_ObservationalUnit", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_ObservationalUnit", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_ObservationalUnit", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_ObservationalUnit = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_ObservationalUnit", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_ObservationalUnit", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_ObservationalUnit", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_ObservationalUnit = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_ObservationalUnit", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_ObservationalUnit", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_ObservationalUnit", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_PairSet = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_PairSet", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_PairSet", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_PairSet", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_PairSet = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_PairSet", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_PairSet", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_PairSet", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_PairSet = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_PairSet", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_PairSet", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_PairSet", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Pairing = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Pairing", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Pairing", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Pairing", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_Pairing = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_Pairing", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_Pairing", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_Pairing", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Pairing = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Pairing", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Pairing", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Pairing", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Person = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Person", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Person", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Person", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_Person = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_Person", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_Person", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_Person", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Person = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Person", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Person", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Person", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_PhenotypeDescription = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_PhenotypeDescription", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_PhenotypeDescription", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_PhenotypeDescription", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_PhenotypeDescription = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_PhenotypeDescription", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_PhenotypeDescription", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_PhenotypeDescription", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_PhenotypeDescription = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_PhenotypeDescription", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_PhenotypeDescription", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_PhenotypeDescription", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_PhenotypeExperiment = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_PhenotypeExperiment", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_PhenotypeExperiment", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_PhenotypeExperiment", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_PhenotypeExperiment = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_PhenotypeExperiment", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_PhenotypeExperiment", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_PhenotypeExperiment", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_PhenotypeExperiment = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_PhenotypeExperiment", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_PhenotypeExperiment", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_PhenotypeExperiment", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_ProbeSet = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_ProbeSet", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_ProbeSet", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_ProbeSet", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_ProbeSet = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_ProbeSet", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_ProbeSet", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_ProbeSet", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_ProbeSet = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_ProbeSet", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_ProbeSet", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_ProbeSet", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_ProteinSequence = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_ProteinSequence", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_ProteinSequence", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_ProteinSequence", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_ProteinSequence = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_ProteinSequence", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_ProteinSequence", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_ProteinSequence", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_ProteinSequence = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_ProteinSequence", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_ProteinSequence", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_ProteinSequence", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Protocol = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Protocol", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Protocol", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Protocol", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_Protocol = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_Protocol", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_Protocol", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_Protocol", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Protocol = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Protocol", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Protocol", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Protocol", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Publication = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Publication", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Publication", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Publication", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_Publication = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_Publication", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_Publication", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_Publication", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Publication = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Publication", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Publication", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Publication", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Reaction = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Reaction", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Reaction", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Reaction", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_Reaction = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_Reaction", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_Reaction", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_Reaction", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Reaction = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Reaction", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Reaction", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Reaction", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_ReactionInstance = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_ReactionInstance", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_ReactionInstance", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_ReactionInstance", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_ReactionInstance = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_ReactionInstance", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_ReactionInstance", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_ReactionInstance", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_ReactionInstance = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_ReactionInstance", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_ReactionInstance", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_ReactionInstance", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Role = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Role", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Role", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Role", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_Role = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_Role", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_Role", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_Role", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Role = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Role", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Role", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Role", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_SSCell = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_SSCell", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_SSCell", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_SSCell", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_SSCell = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_SSCell", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_SSCell", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_SSCell", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_SSCell = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_SSCell", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_SSCell", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_SSCell", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_SSRow = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_SSRow", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_SSRow", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_SSRow", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_SSRow = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_SSRow", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_SSRow", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_SSRow", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_SSRow = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_SSRow", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_SSRow", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_SSRow", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Scenario = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Scenario", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Scenario", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Scenario", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_Scenario = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_Scenario", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_Scenario", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_Scenario", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Scenario = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Scenario", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Scenario", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Scenario", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Source = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Source", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Source", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Source", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_Source = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_Source", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_Source", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_Source", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Source = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Source", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Source", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Source", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Strain = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Strain", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Strain", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Strain", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_Strain = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_Strain", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_Strain", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_Strain", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Strain = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Strain", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Strain", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Strain", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_StudyExperiment = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_StudyExperiment", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_StudyExperiment", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_StudyExperiment", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_StudyExperiment = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_StudyExperiment", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_StudyExperiment", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_StudyExperiment", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_StudyExperiment = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_StudyExperiment", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_StudyExperiment", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_StudyExperiment", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Subsystem = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Subsystem", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Subsystem", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Subsystem", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_Subsystem = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_Subsystem", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_Subsystem", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_Subsystem", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Subsystem = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Subsystem", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Subsystem", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Subsystem", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_SubsystemClass = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_SubsystemClass", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_SubsystemClass", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_SubsystemClass", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_SubsystemClass = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_SubsystemClass", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_SubsystemClass", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_SubsystemClass", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_SubsystemClass = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_SubsystemClass", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_SubsystemClass", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_SubsystemClass", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_TaxonomicGrouping = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_TaxonomicGrouping", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_TaxonomicGrouping", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_TaxonomicGrouping", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_TaxonomicGrouping = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_TaxonomicGrouping", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_TaxonomicGrouping", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_TaxonomicGrouping", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_TaxonomicGrouping = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_TaxonomicGrouping", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_TaxonomicGrouping", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_TaxonomicGrouping", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Trait = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Trait", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Trait", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Trait", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_Trait = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_Trait", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_Trait", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_Trait", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Trait = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Trait", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Trait", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Trait", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Tree = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Tree", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Tree", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Tree", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_Tree = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_Tree", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_Tree", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_Tree", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Tree = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Tree", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Tree", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Tree", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_TreeAttribute = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_TreeAttribute", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_TreeAttribute", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_TreeAttribute", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_TreeAttribute = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_TreeAttribute", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_TreeAttribute", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_TreeAttribute", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_TreeAttribute = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_TreeAttribute", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_TreeAttribute", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_TreeAttribute", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_TreeNodeAttribute = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_TreeNodeAttribute", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_TreeNodeAttribute", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_TreeNodeAttribute", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_TreeNodeAttribute = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_TreeNodeAttribute", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_TreeNodeAttribute", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_TreeNodeAttribute", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_TreeNodeAttribute = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_TreeNodeAttribute", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_TreeNodeAttribute", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_TreeNodeAttribute", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Variant = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Variant", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Variant", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Variant", [ids, fields], 1, _callback, _error_callback)
    }

    this.query_entity_Variant = function(qry, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.query_entity_Variant", [qry, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.query_entity_Variant", [qry, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.query_entity_Variant", [qry, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Variant = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Variant", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Variant", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Variant", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_relationship_AffectsLevelOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_AffectsLevelOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_AffectsLevelOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_AffectsLevelOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsAffectedIn = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsAffectedIn", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsAffectedIn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsAffectedIn", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_Aligned = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_Aligned", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Aligned", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_Aligned", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_WasAlignedBy = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_WasAlignedBy", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_WasAlignedBy", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_WasAlignedBy", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_AssertsFunctionFor = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_AssertsFunctionFor", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_AssertsFunctionFor", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_AssertsFunctionFor", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasAssertedFunctionFrom = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasAssertedFunctionFrom", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasAssertedFunctionFrom", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasAssertedFunctionFrom", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_BelongsTo = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_BelongsTo", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_BelongsTo", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_BelongsTo", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IncludesStrain = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IncludesStrain", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IncludesStrain", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IncludesStrain", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_Concerns = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_Concerns", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Concerns", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_Concerns", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsATopicOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsATopicOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsATopicOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsATopicOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_ConsistsOfCompounds = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_ConsistsOfCompounds", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_ConsistsOfCompounds", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_ConsistsOfCompounds", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_ComponentOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_ComponentOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_ComponentOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_ComponentOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_Contains = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_Contains", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Contains", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_Contains", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsContainedIn = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsContainedIn", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsContainedIn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsContainedIn", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_ContainsAlignedDNA = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_ContainsAlignedDNA", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_ContainsAlignedDNA", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_ContainsAlignedDNA", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsAlignedDNAComponentOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsAlignedDNAComponentOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsAlignedDNAComponentOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsAlignedDNAComponentOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_ContainsAlignedProtein = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_ContainsAlignedProtein", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_ContainsAlignedProtein", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_ContainsAlignedProtein", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsAlignedProteinComponentOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsAlignedProteinComponentOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsAlignedProteinComponentOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsAlignedProteinComponentOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_Controls = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_Controls", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Controls", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_Controls", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsControlledUsing = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsControlledUsing", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsControlledUsing", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsControlledUsing", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_DerivedFromStrain = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_DerivedFromStrain", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_DerivedFromStrain", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_DerivedFromStrain", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_StrainParentOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_StrainParentOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_StrainParentOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_StrainParentOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_Describes = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_Describes", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Describes", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_Describes", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsDescribedBy = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsDescribedBy", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsDescribedBy", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsDescribedBy", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_DescribesAlignment = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_DescribesAlignment", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_DescribesAlignment", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_DescribesAlignment", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasAlignmentAttribute = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasAlignmentAttribute", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasAlignmentAttribute", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasAlignmentAttribute", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_DescribesTree = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_DescribesTree", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_DescribesTree", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_DescribesTree", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasTreeAttribute = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasTreeAttribute", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasTreeAttribute", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasTreeAttribute", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_DescribesTreeNode = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_DescribesTreeNode", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_DescribesTreeNode", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_DescribesTreeNode", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasNodeAttribute = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasNodeAttribute", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasNodeAttribute", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasNodeAttribute", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_Displays = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_Displays", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Displays", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_Displays", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsDisplayedOn = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsDisplayedOn", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsDisplayedOn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsDisplayedOn", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_Encompasses = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_Encompasses", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Encompasses", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_Encompasses", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsEncompassedIn = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsEncompassedIn", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsEncompassedIn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsEncompassedIn", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_Formulated = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_Formulated", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Formulated", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_Formulated", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_WasFormulatedBy = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_WasFormulatedBy", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_WasFormulatedBy", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_WasFormulatedBy", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_GeneratedLevelsFor = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_GeneratedLevelsFor", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_GeneratedLevelsFor", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_GeneratedLevelsFor", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_WasGeneratedFrom = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_WasGeneratedFrom", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_WasGeneratedFrom", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_WasGeneratedFrom", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_GenomeParentOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_GenomeParentOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_GenomeParentOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_GenomeParentOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_DerivedFromGenome = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_DerivedFromGenome", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_DerivedFromGenome", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_DerivedFromGenome", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasAssociatedMeasurement = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasAssociatedMeasurement", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasAssociatedMeasurement", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasAssociatedMeasurement", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_MeasuresPhenotype = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_MeasuresPhenotype", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_MeasuresPhenotype", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_MeasuresPhenotype", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasCompoundAliasFrom = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasCompoundAliasFrom", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasCompoundAliasFrom", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasCompoundAliasFrom", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_UsesAliasForCompound = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_UsesAliasForCompound", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_UsesAliasForCompound", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_UsesAliasForCompound", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasExperimentalUnit = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasExperimentalUnit", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasExperimentalUnit", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasExperimentalUnit", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsExperimentalUnitOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsExperimentalUnitOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsExperimentalUnitOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsExperimentalUnitOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasIndicatedSignalFrom = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasIndicatedSignalFrom", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasIndicatedSignalFrom", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasIndicatedSignalFrom", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IndicatesSignalFor = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IndicatesSignalFor", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IndicatesSignalFor", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IndicatesSignalFor", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasKnockoutIn = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasKnockoutIn", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasKnockoutIn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasKnockoutIn", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_KnockedOutIn = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_KnockedOutIn", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_KnockedOutIn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_KnockedOutIn", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasMeasurement = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasMeasurement", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasMeasurement", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasMeasurement", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsMeasureOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsMeasureOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsMeasureOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsMeasureOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasMember = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasMember", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasMember", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasMember", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsMemberOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsMemberOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsMemberOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsMemberOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasParticipant = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasParticipant", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasParticipant", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasParticipant", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_ParticipatesIn = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_ParticipatesIn", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_ParticipatesIn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_ParticipatesIn", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasPresenceOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasPresenceOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasPresenceOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasPresenceOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsPresentIn = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsPresentIn", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsPresentIn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsPresentIn", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasProteinMember = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasProteinMember", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasProteinMember", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasProteinMember", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsProteinMemberOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsProteinMemberOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsProteinMemberOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsProteinMemberOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasReactionAliasFrom = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasReactionAliasFrom", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasReactionAliasFrom", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasReactionAliasFrom", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_UsesAliasForReaction = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_UsesAliasForReaction", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_UsesAliasForReaction", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_UsesAliasForReaction", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasRepresentativeOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasRepresentativeOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasRepresentativeOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasRepresentativeOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsRepresentedIn = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsRepresentedIn", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsRepresentedIn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsRepresentedIn", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasRequirementOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasRequirementOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasRequirementOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasRequirementOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsARequirementOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsARequirementOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsARequirementOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsARequirementOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasResultsIn = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasResultsIn", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasResultsIn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasResultsIn", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasResultsFor = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasResultsFor", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasResultsFor", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasResultsFor", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasSection = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasSection", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasSection", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasSection", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsSectionOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsSectionOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsSectionOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsSectionOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasStep = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasStep", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasStep", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasStep", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsStepOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsStepOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsStepOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsStepOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasTrait = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasTrait", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasTrait", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasTrait", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_Measures = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_Measures", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Measures", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_Measures", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasUnits = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasUnits", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasUnits", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasUnits", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsLocated = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsLocated", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsLocated", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsLocated", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasUsage = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasUsage", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasUsage", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasUsage", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsUsageOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsUsageOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsUsageOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsUsageOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasValueFor = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasValueFor", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasValueFor", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasValueFor", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasValueIn = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasValueIn", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasValueIn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasValueIn", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasVariationIn = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasVariationIn", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasVariationIn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasVariationIn", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsVariedIn = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsVariedIn", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsVariedIn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsVariedIn", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_Impacts = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_Impacts", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Impacts", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_Impacts", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsImpactedBy = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsImpactedBy", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsImpactedBy", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsImpactedBy", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_ImplementsReaction = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_ImplementsReaction", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_ImplementsReaction", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_ImplementsReaction", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_ImplementedBasedOn = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_ImplementedBasedOn", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_ImplementedBasedOn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_ImplementedBasedOn", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_Includes = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_Includes", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Includes", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_Includes", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsIncludedIn = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsIncludedIn", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsIncludedIn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsIncludedIn", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IncludesAdditionalCompounds = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IncludesAdditionalCompounds", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IncludesAdditionalCompounds", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IncludesAdditionalCompounds", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IncludedIn = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IncludedIn", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IncludedIn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IncludedIn", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IncludesAlignmentRow = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IncludesAlignmentRow", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IncludesAlignmentRow", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IncludesAlignmentRow", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsAlignmentRowIn = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsAlignmentRowIn", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsAlignmentRowIn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsAlignmentRowIn", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IncludesPart = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IncludesPart", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IncludesPart", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IncludesPart", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsPartOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsPartOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsPartOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsPartOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IndicatedLevelsFor = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IndicatedLevelsFor", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IndicatedLevelsFor", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IndicatedLevelsFor", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasLevelsFrom = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasLevelsFrom", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasLevelsFrom", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasLevelsFrom", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_Involves = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_Involves", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Involves", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_Involves", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsInvolvedIn = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsInvolvedIn", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsInvolvedIn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsInvolvedIn", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsAnnotatedBy = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsAnnotatedBy", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsAnnotatedBy", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsAnnotatedBy", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_Annotates = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_Annotates", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Annotates", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_Annotates", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsAssayOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsAssayOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsAssayOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsAssayOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsAssayedBy = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsAssayedBy", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsAssayedBy", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsAssayedBy", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsClassFor = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsClassFor", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsClassFor", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsClassFor", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsInClass = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsInClass", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsInClass", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsInClass", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsCollectionOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsCollectionOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsCollectionOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsCollectionOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsCollectedInto = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsCollectedInto", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsCollectedInto", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsCollectedInto", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsComposedOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsComposedOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsComposedOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsComposedOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsComponentOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsComponentOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsComponentOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsComponentOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsComprisedOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsComprisedOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsComprisedOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsComprisedOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_Comprises = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_Comprises", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Comprises", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_Comprises", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsConfiguredBy = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsConfiguredBy", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsConfiguredBy", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsConfiguredBy", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_ReflectsStateOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_ReflectsStateOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_ReflectsStateOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_ReflectsStateOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsConsistentWith = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsConsistentWith", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsConsistentWith", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsConsistentWith", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsConsistentTo = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsConsistentTo", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsConsistentTo", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsConsistentTo", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsCoregulatedWith = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsCoregulatedWith", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsCoregulatedWith", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsCoregulatedWith", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasCoregulationWith = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasCoregulationWith", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasCoregulationWith", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasCoregulationWith", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsCoupledTo = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsCoupledTo", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsCoupledTo", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsCoupledTo", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsCoupledWith = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsCoupledWith", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsCoupledWith", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsCoupledWith", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsDeterminedBy = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsDeterminedBy", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsDeterminedBy", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsDeterminedBy", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_Determines = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_Determines", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Determines", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_Determines", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsDividedInto = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsDividedInto", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsDividedInto", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsDividedInto", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsDivisionOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsDivisionOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsDivisionOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsDivisionOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsExecutedAs = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsExecutedAs", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsExecutedAs", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsExecutedAs", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsExecutionOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsExecutionOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsExecutionOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsExecutionOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsExemplarOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsExemplarOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsExemplarOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsExemplarOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasAsExemplar = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasAsExemplar", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasAsExemplar", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasAsExemplar", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsFamilyFor = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsFamilyFor", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsFamilyFor", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsFamilyFor", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_DeterminesFunctionOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_DeterminesFunctionOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_DeterminesFunctionOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_DeterminesFunctionOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsFormedOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsFormedOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsFormedOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsFormedOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsFormedInto = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsFormedInto", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsFormedInto", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsFormedInto", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsFunctionalIn = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsFunctionalIn", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsFunctionalIn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsFunctionalIn", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasFunctional = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasFunctional", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasFunctional", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasFunctional", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsGroupFor = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsGroupFor", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsGroupFor", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsGroupFor", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsInGroup = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsInGroup", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsInGroup", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsInGroup", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsImplementedBy = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsImplementedBy", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsImplementedBy", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsImplementedBy", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_Implements = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_Implements", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Implements", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_Implements", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsInPair = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsInPair", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsInPair", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsInPair", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsPairOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsPairOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsPairOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsPairOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsInstantiatedBy = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsInstantiatedBy", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsInstantiatedBy", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsInstantiatedBy", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsInstanceOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsInstanceOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsInstanceOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsInstanceOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsLocatedIn = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsLocatedIn", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsLocatedIn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsLocatedIn", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsLocusFor = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsLocusFor", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsLocusFor", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsLocusFor", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsMeasurementMethodOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsMeasurementMethodOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsMeasurementMethodOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsMeasurementMethodOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_WasMeasuredBy = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_WasMeasuredBy", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_WasMeasuredBy", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_WasMeasuredBy", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsModeledBy = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsModeledBy", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsModeledBy", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsModeledBy", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_Models = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_Models", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Models", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_Models", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsModifiedToBuildAlignment = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsModifiedToBuildAlignment", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsModifiedToBuildAlignment", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsModifiedToBuildAlignment", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsModificationOfAlignment = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsModificationOfAlignment", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsModificationOfAlignment", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsModificationOfAlignment", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsModifiedToBuildTree = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsModifiedToBuildTree", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsModifiedToBuildTree", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsModifiedToBuildTree", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsModificationOfTree = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsModificationOfTree", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsModificationOfTree", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsModificationOfTree", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsOwnerOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsOwnerOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsOwnerOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsOwnerOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsOwnedBy = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsOwnedBy", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsOwnedBy", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsOwnedBy", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsParticipatingAt = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsParticipatingAt", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsParticipatingAt", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsParticipatingAt", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_ParticipatesAt = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_ParticipatesAt", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_ParticipatesAt", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_ParticipatesAt", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsProteinFor = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsProteinFor", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsProteinFor", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsProteinFor", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_Produces = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_Produces", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Produces", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_Produces", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsReagentIn = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsReagentIn", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsReagentIn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsReagentIn", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_Targets = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_Targets", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Targets", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_Targets", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsRealLocationOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsRealLocationOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsRealLocationOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsRealLocationOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasRealLocationIn = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasRealLocationIn", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasRealLocationIn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasRealLocationIn", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsReferencedBy = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsReferencedBy", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsReferencedBy", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsReferencedBy", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_UsesReference = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_UsesReference", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_UsesReference", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_UsesReference", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsRegulatedIn = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsRegulatedIn", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsRegulatedIn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsRegulatedIn", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsRegulatedSetOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsRegulatedSetOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsRegulatedSetOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsRegulatedSetOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsRelevantFor = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsRelevantFor", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsRelevantFor", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsRelevantFor", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsRelevantTo = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsRelevantTo", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsRelevantTo", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsRelevantTo", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsRepresentedBy = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsRepresentedBy", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsRepresentedBy", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsRepresentedBy", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_DefinedBy = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_DefinedBy", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_DefinedBy", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_DefinedBy", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsRoleOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsRoleOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsRoleOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsRoleOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasRole = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasRole", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasRole", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasRole", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsRowOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsRowOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsRowOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsRowOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsRoleFor = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsRoleFor", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsRoleFor", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsRoleFor", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsSequenceOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsSequenceOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsSequenceOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsSequenceOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasAsSequence = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasAsSequence", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasAsSequence", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasAsSequence", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsSubInstanceOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsSubInstanceOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsSubInstanceOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsSubInstanceOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_Validates = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_Validates", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Validates", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_Validates", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsSummarizedBy = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsSummarizedBy", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsSummarizedBy", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsSummarizedBy", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_Summarizes = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_Summarizes", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Summarizes", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_Summarizes", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsSuperclassOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsSuperclassOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsSuperclassOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsSuperclassOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsSubclassOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsSubclassOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsSubclassOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsSubclassOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsTaxonomyOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsTaxonomyOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsTaxonomyOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsTaxonomyOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsInTaxa = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsInTaxa", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsInTaxa", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsInTaxa", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsTerminusFor = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsTerminusFor", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsTerminusFor", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsTerminusFor", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasAsTerminus = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasAsTerminus", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasAsTerminus", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasAsTerminus", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsTriggeredBy = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsTriggeredBy", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsTriggeredBy", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsTriggeredBy", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_Triggers = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_Triggers", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Triggers", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_Triggers", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsUsedToBuildTree = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsUsedToBuildTree", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsUsedToBuildTree", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsUsedToBuildTree", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsBuiltFromAlignment = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsBuiltFromAlignment", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsBuiltFromAlignment", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsBuiltFromAlignment", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_Manages = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_Manages", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Manages", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_Manages", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsManagedBy = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsManagedBy", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsManagedBy", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsManagedBy", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_OperatesIn = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_OperatesIn", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_OperatesIn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_OperatesIn", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsUtilizedIn = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsUtilizedIn", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsUtilizedIn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsUtilizedIn", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_Overlaps = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_Overlaps", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Overlaps", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_Overlaps", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IncludesPartOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IncludesPartOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IncludesPartOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IncludesPartOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_ParticipatesAs = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_ParticipatesAs", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_ParticipatesAs", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_ParticipatesAs", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsParticipationOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsParticipationOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsParticipationOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsParticipationOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_PerformedExperiment = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_PerformedExperiment", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_PerformedExperiment", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_PerformedExperiment", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_PerformedBy = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_PerformedBy", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_PerformedBy", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_PerformedBy", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_ProducedResultsFor = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_ProducedResultsFor", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_ProducedResultsFor", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_ProducedResultsFor", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HadResultsProducedBy = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HadResultsProducedBy", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HadResultsProducedBy", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HadResultsProducedBy", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_Provided = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_Provided", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Provided", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_Provided", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_WasProvidedBy = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_WasProvidedBy", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_WasProvidedBy", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_WasProvidedBy", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_PublishedExperiment = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_PublishedExperiment", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_PublishedExperiment", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_PublishedExperiment", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_ExperimentPublishedIn = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_ExperimentPublishedIn", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_ExperimentPublishedIn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_ExperimentPublishedIn", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_PublishedProtocol = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_PublishedProtocol", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_PublishedProtocol", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_PublishedProtocol", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_ProtocolPublishedIn = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_ProtocolPublishedIn", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_ProtocolPublishedIn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_ProtocolPublishedIn", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_Shows = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_Shows", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Shows", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_Shows", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsShownOn = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsShownOn", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsShownOn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsShownOn", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_Submitted = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_Submitted", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Submitted", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_Submitted", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_WasSubmittedBy = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_WasSubmittedBy", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_WasSubmittedBy", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_WasSubmittedBy", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_SupersedesAlignment = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_SupersedesAlignment", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_SupersedesAlignment", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_SupersedesAlignment", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsSupersededByAlignment = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsSupersededByAlignment", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsSupersededByAlignment", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsSupersededByAlignment", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_SupersedesTree = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_SupersedesTree", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_SupersedesTree", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_SupersedesTree", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsSupersededByTree = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsSupersededByTree", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsSupersededByTree", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsSupersededByTree", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_Treed = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_Treed", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Treed", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_Treed", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsTreeFrom = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsTreeFrom", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsTreeFrom", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsTreeFrom", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_UsedBy = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_UsedBy", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_UsedBy", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_UsedBy", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_UsesMedia = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_UsesMedia", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_UsesMedia", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_UsesMedia", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_UsedInExperimentalUnit = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_UsedInExperimentalUnit", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_UsedInExperimentalUnit", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_UsedInExperimentalUnit", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasEnvironment = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasEnvironment", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasEnvironment", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasEnvironment", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_Uses = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_Uses", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Uses", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_Uses", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsUsedBy = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsUsedBy", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsUsedBy", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsUsedBy", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_UsesCodons = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_UsesCodons", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_UsesCodons", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_UsesCodons", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_AreCodonsFor = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_AreCodonsFor", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_AreCodonsFor", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_AreCodonsFor", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }
...
function KBaseRegPrecise(url) {
    ...
    {
	var resp = json_call_ajax_sync(_url,"KBaseRegPrecise.getRegulomeModelCollections", []);
//	var resp = json_call_sync("KBaseRegPrecise.getRegulomeModelCollections", []);
    ...
    {
	json_call_ajax_async(_url,"KBaseRegPrecise.getRegulomeModelCollections", [], 1, _callback, _error_callback)
    }

    this.getRegulomeModelCollection = function(collectionId)
    {
	var resp = json_call_ajax_sync(_url,"KBaseRegPrecise.getRegulomeModelCollection", [collectionId]);
//	var resp = json_call_sync("KBaseRegPrecise.getRegulomeModelCollection", [collectionId]);
    ...
    {
	json_call_ajax_async(_url,"KBaseRegPrecise.getRegulomeModelCollection", [collectionId], 1, _callback, _error_callback)
    }

    this.getRegulomeModelsByCollectionId = function(collectionId)
    {
	var resp = json_call_ajax_sync(_url,"KBaseRegPrecise.getRegulomeModelsByCollectionId", [collectionId]);
//	var resp = json_call_sync("KBaseRegPrecise.getRegulomeModelsByCollectionId", [collectionId]);
    ...
    {
	json_call_ajax_async(_url,"KBaseRegPrecise.getRegulomeModelsByCollectionId", [collectionId], 1, _callback, _error_callback)
    }

    this.getRegulomeModelsByGenomeId = function(genomeId)
    {
	var resp = json_call_ajax_sync(_url,"KBaseRegPrecise.getRegulomeModelsByGenomeId", [genomeId]);
//	var resp = json_call_sync("KBaseRegPrecise.getRegulomeModelsByGenomeId", [genomeId]);
    ...
    {
	json_call_ajax_async(_url,"KBaseRegPrecise.getRegulomeModelsByGenomeId", [genomeId], 1, _callback, _error_callback)
    }

    this.getRegulomeModelsBySourceType = function(regulomeSource)
    {
	var resp = json_call_ajax_sync(_url,"KBaseRegPrecise.getRegulomeModelsBySourceType", [regulomeSource]);
//	var resp = json_call_sync("KBaseRegPrecise.getRegulomeModelsBySourceType", [regulomeSource]);
    ...
    {
	json_call_ajax_async(_url,"KBaseRegPrecise.getRegulomeModelsBySourceType", [regulomeSource], 1, _callback, _error_callback)
    }

    this.getRegulomeModel = function(regulomeModelId)
    {
	var resp = json_call_ajax_sync(_url,"KBaseRegPrecise.getRegulomeModel", [regulomeModelId]);
//	var resp = json_call_sync("KBaseRegPrecise.getRegulomeModel", [regulomeModelId]);
    ...
    {
	json_call_ajax_async(_url,"KBaseRegPrecise.getRegulomeModel", [regulomeModelId], 1, _callback, _error_callback)
    }

    this.getRegulonModelStats = function(regulomeModelId)
    {
	var resp = json_call_ajax_sync(_url,"KBaseRegPrecise.getRegulonModelStats", [regulomeModelId]);
//	var resp = json_call_sync("KBaseRegPrecise.getRegulonModelStats", [regulomeModelId]);
    ...
    {
	json_call_ajax_async(_url,"KBaseRegPrecise.getRegulonModelStats", [regulomeModelId], 1, _callback, _error_callback)
    }

    this.getRegulonModel = function(regulonModelId)
    {
	var resp = json_call_ajax_sync(_url,"KBaseRegPrecise.getRegulonModel", [regulonModelId]);
//	var resp = json_call_sync("KBaseRegPrecise.getRegulonModel", [regulonModelId]);
    ...
    {
	json_call_ajax_async(_url,"KBaseRegPrecise.getRegulonModel", [regulonModelId], 1, _callback, _error_callback)
    }

    this.buildRegulomeModel = function(param)
    {
	var resp = json_call_ajax_sync(_url,"KBaseRegPrecise.buildRegulomeModel", [param]);
//	var resp = json_call_sync("KBaseRegPrecise.buildRegulomeModel", [param]);
    ...
    {
	json_call_ajax_async(_url,"KBaseRegPrecise.buildRegulomeModel", [param], 1, _callback, _error_callback)
    }

    this.getProcessState = function(processId)
    {
	var resp = json_call_ajax_sync(_url,"KBaseRegPrecise.getProcessState", [processId]);
//	var resp = json_call_sync("KBaseRegPrecise.getProcessState", [processId]);
    ...
    {
	json_call_ajax_async(_url,"KBaseRegPrecise.getProcessState", [processId], 1, _callback, _error_callback)
    }
...
function MOTranslation(url) {
    ...
    {
	var resp = json_call_ajax_sync(_url,"MOTranslation.fids_to_moLocusIds", [fids]);
//	var resp = json_call_sync("MOTranslation.fids_to_moLocusIds", [fids]);
    ...
    {
	json_call_ajax_async(_url,"MOTranslation.fids_to_moLocusIds", [fids], 1, _callback, _error_callback)
    }

    this.proteins_to_moLocusIds = function(proteins)
    {
	var resp = json_call_ajax_sync(_url,"MOTranslation.proteins_to_moLocusIds", [proteins]);
//	var resp = json_call_sync("MOTranslation.proteins_to_moLocusIds", [proteins]);
    ...
    {
	json_call_ajax_async(_url,"MOTranslation.proteins_to_moLocusIds", [proteins], 1, _callback, _error_callback)
    }

    this.moLocusIds_to_fids = function(moLocusIds)
    {
	var resp = json_call_ajax_sync(_url,"MOTranslation.moLocusIds_to_fids", [moLocusIds]);
//	var resp = json_call_sync("MOTranslation.moLocusIds_to_fids", [moLocusIds]);
    ...
    {
	json_call_ajax_async(_url,"MOTranslation.moLocusIds_to_fids", [moLocusIds], 1, _callback, _error_callback)
    }

    this.moLocusIds_to_proteins = function(moLocusIds)
    {
	var resp = json_call_ajax_sync(_url,"MOTranslation.moLocusIds_to_proteins", [moLocusIds]);
//	var resp = json_call_sync("MOTranslation.moLocusIds_to_proteins", [moLocusIds]);
    ...
    {
	json_call_ajax_async(_url,"MOTranslation.moLocusIds_to_proteins", [moLocusIds], 1, _callback, _error_callback)
    }

    this.map_to_fid = function(query_sequences, genomeId)
    {
	var resp = json_call_ajax_sync(_url,"MOTranslation.map_to_fid", [query_sequences, genomeId]);
//	var resp = json_call_sync("MOTranslation.map_to_fid", [query_sequences, genomeId]);
    ...
    {
	json_call_ajax_async(_url,"MOTranslation.map_to_fid", [query_sequences, genomeId], 2, _callback, _error_callback)
    }

    this.map_to_fid_fast = function(query_md5s, genomeId)
    {
	var resp = json_call_ajax_sync(_url,"MOTranslation.map_to_fid_fast", [query_md5s, genomeId]);
//	var resp = json_call_sync("MOTranslation.map_to_fid_fast", [query_md5s, genomeId]);
    ...
    {
	json_call_ajax_async(_url,"MOTranslation.map_to_fid_fast", [query_md5s, genomeId], 2, _callback, _error_callback)
    }

    this.moLocusIds_to_fid_in_genome = function(moLocusIds, genomeId)
    {
	var resp = json_call_ajax_sync(_url,"MOTranslation.moLocusIds_to_fid_in_genome", [moLocusIds, genomeId]);
//	var resp = json_call_sync("MOTranslation.moLocusIds_to_fid_in_genome", [moLocusIds, genomeId]);
    ...
    {
	json_call_ajax_async(_url,"MOTranslation.moLocusIds_to_fid_in_genome", [moLocusIds, genomeId], 2, _callback, _error_callback)
    }

    this.moLocusIds_to_fid_in_genome_fast = function(moLocusIds, genomeId)
    {
	var resp = json_call_ajax_sync(_url,"MOTranslation.moLocusIds_to_fid_in_genome_fast", [moLocusIds, genomeId]);
//	var resp = json_call_sync("MOTranslation.moLocusIds_to_fid_in_genome_fast", [moLocusIds, genomeId]);
    ...
    {
	json_call_ajax_async(_url,"MOTranslation.moLocusIds_to_fid_in_genome_fast", [moLocusIds, genomeId], 2, _callback, _error_callback)
    }

    this.moTaxonomyId_to_genomes = function(moTaxonomyId)
    {
	var resp = json_call_ajax_sync(_url,"MOTranslation.moTaxonomyId_to_genomes", [moTaxonomyId]);
//	var resp = json_call_sync("MOTranslation.moTaxonomyId_to_genomes", [moTaxonomyId]);
    ...
    {
	json_call_ajax_async(_url,"MOTranslation.moTaxonomyId_to_genomes", [moTaxonomyId], 1, _callback, _error_callback)
    }
...
function PlantExpression(url) {
    ...
    {
	var resp = json_call_ajax_sync(_url,"PlantExpression.getExperimentsBySeriesID", [ids]);
//	var resp = json_call_sync("PlantExpression.getExperimentsBySeriesID", [ids]);
    ...
    {
	json_call_ajax_async(_url,"PlantExpression.getExperimentsBySeriesID", [ids], 1, _callback, _error_callback)
    }

    this.getExperimentsBySampleID = function(ids)
    {
	var resp = json_call_ajax_sync(_url,"PlantExpression.getExperimentsBySampleID", [ids]);
//	var resp = json_call_sync("PlantExpression.getExperimentsBySampleID", [ids]);
    ...
    {
	json_call_ajax_async(_url,"PlantExpression.getExperimentsBySampleID", [ids], 1, _callback, _error_callback)
    }

    this.getExperimentsBySampleIDnGeneID = function(ids, gl)
    {
	var resp = json_call_ajax_sync(_url,"PlantExpression.getExperimentsBySampleIDnGeneID", [ids, gl]);
//	var resp = json_call_sync("PlantExpression.getExperimentsBySampleIDnGeneID", [ids, gl]);
    ...
    {
	json_call_ajax_async(_url,"PlantExpression.getExperimentsBySampleIDnGeneID", [ids, gl], 1, _callback, _error_callback)
    }

    this.getEOSampleIDList = function(lst)
    {
	var resp = json_call_ajax_sync(_url,"PlantExpression.getEOSampleIDList", [lst]);
//	var resp = json_call_sync("PlantExpression.getEOSampleIDList", [lst]);
    ...
    {
	json_call_ajax_async(_url,"PlantExpression.getEOSampleIDList", [lst], 1, _callback, _error_callback)
    }

    this.getPOSampleIDList = function(lst)
    {
	var resp = json_call_ajax_sync(_url,"PlantExpression.getPOSampleIDList", [lst]);
//	var resp = json_call_sync("PlantExpression.getPOSampleIDList", [lst]);
    ...
    {
	json_call_ajax_async(_url,"PlantExpression.getPOSampleIDList", [lst], 1, _callback, _error_callback)
    }

    this.getAllPO = function()
    {
	var resp = json_call_ajax_sync(_url,"PlantExpression.getAllPO", []);
//	var resp = json_call_sync("PlantExpression.getAllPO", []);
    ...
    {
	json_call_ajax_async(_url,"PlantExpression.getAllPO", [], 1, _callback, _error_callback)
    }

    this.getAllEO = function()
    {
	var resp = json_call_ajax_sync(_url,"PlantExpression.getAllEO", []);
//	var resp = json_call_sync("PlantExpression.getAllEO", []);
    ...
    {
	json_call_ajax_async(_url,"PlantExpression.getAllEO", [], 1, _callback, _error_callback)
    }

    this.getPODescriptions = function(ids)
    {
	var resp = json_call_ajax_sync(_url,"PlantExpression.getPODescriptions", [ids]);
//	var resp = json_call_sync("PlantExpression.getPODescriptions", [ids]);
    ...
    {
	json_call_ajax_async(_url,"PlantExpression.getPODescriptions", [ids], 1, _callback, _error_callback)
    }

    this.getEODescriptions = function(ids)
    {
	var resp = json_call_ajax_sync(_url,"PlantExpression.getEODescriptions", [ids]);
//	var resp = json_call_sync("PlantExpression.getEODescriptions", [ids]);
    ...
    {
	json_call_ajax_async(_url,"PlantExpression.getEODescriptions", [ids], 1, _callback, _error_callback)
    }
...
function ProteinInfo(url) {
    ...
    {
	var resp = json_call_ajax_sync(_url,"ProteinInfo.fids_to_operons", [fids]);
//	var resp = json_call_sync("ProteinInfo.fids_to_operons", [fids]);
    ...
    {
	json_call_ajax_async(_url,"ProteinInfo.fids_to_operons", [fids], 1, _callback, _error_callback)
    }

    this.fids_to_domains = function(fids)
    {
	var resp = json_call_ajax_sync(_url,"ProteinInfo.fids_to_domains", [fids]);
//	var resp = json_call_sync("ProteinInfo.fids_to_domains", [fids]);
    ...
    {
	json_call_ajax_async(_url,"ProteinInfo.fids_to_domains", [fids], 1, _callback, _error_callback)
    }

    this.domains_to_fids = function(domain_ids)
    {
	var resp = json_call_ajax_sync(_url,"ProteinInfo.domains_to_fids", [domain_ids]);
//	var resp = json_call_sync("ProteinInfo.domains_to_fids", [domain_ids]);
    ...
    {
	json_call_ajax_async(_url,"ProteinInfo.domains_to_fids", [domain_ids], 1, _callback, _error_callback)
    }

    this.fids_to_ipr = function(fids)
    {
	var resp = json_call_ajax_sync(_url,"ProteinInfo.fids_to_ipr", [fids]);
//	var resp = json_call_sync("ProteinInfo.fids_to_ipr", [fids]);
    ...
    {
	json_call_ajax_async(_url,"ProteinInfo.fids_to_ipr", [fids], 1, _callback, _error_callback)
    }

    this.fids_to_orthologs = function(fids)
    {
	var resp = json_call_ajax_sync(_url,"ProteinInfo.fids_to_orthologs", [fids]);
//	var resp = json_call_sync("ProteinInfo.fids_to_orthologs", [fids]);
    ...
    {
	json_call_ajax_async(_url,"ProteinInfo.fids_to_orthologs", [fids], 1, _callback, _error_callback)
    }

    this.fids_to_ec = function(fids)
    {
	var resp = json_call_ajax_sync(_url,"ProteinInfo.fids_to_ec", [fids]);
//	var resp = json_call_sync("ProteinInfo.fids_to_ec", [fids]);
    ...
    {
	json_call_ajax_async(_url,"ProteinInfo.fids_to_ec", [fids], 1, _callback, _error_callback)
    }

    this.fids_to_go = function(fids)
    {
	var resp = json_call_ajax_sync(_url,"ProteinInfo.fids_to_go", [fids]);
//	var resp = json_call_sync("ProteinInfo.fids_to_go", [fids]);
    ...
    {
	json_call_ajax_async(_url,"ProteinInfo.fids_to_go", [fids], 1, _callback, _error_callback)
    }
...
function FileType(url) {
    ...
    {
	var resp = json_call_ajax_sync(_url,"FileType.get_file_type", [id]);
//	var resp = json_call_sync("FileType.get_file_type", [id]);
    ...
    {
	json_call_ajax_async(_url,"FileType.get_file_type", [id], 1, _callback, _error_callback)
    }

    this.get_this_file_type_only = function(id)
    {
	var resp = json_call_ajax_sync(_url,"FileType.get_this_file_type_only", [id]);
//	var resp = json_call_sync("FileType.get_this_file_type_only", [id]);
    ...
    {
	json_call_ajax_async(_url,"FileType.get_this_file_type_only", [id], 1, _callback, _error_callback)
    }

    this.get_file_type_name = function(id)
    {
	var resp = json_call_ajax_sync(_url,"FileType.get_file_type_name", [id]);
//	var resp = json_call_sync("FileType.get_file_type_name", [id]);
    ...
    {
	json_call_ajax_async(_url,"FileType.get_file_type_name", [id], 1, _callback, _error_callback)
    }

    this.get_file_type_names = function(ids)
    {
	var resp = json_call_ajax_sync(_url,"FileType.get_file_type_names", [ids]);
//	var resp = json_call_sync("FileType.get_file_type_names", [ids]);
    ...
    {
	json_call_ajax_async(_url,"FileType.get_file_type_names", [ids], 1, _callback, _error_callback)
    }

    this.get_default_extension = function(id)
    {
	var resp = json_call_ajax_sync(_url,"FileType.get_default_extension", [id]);
//	var resp = json_call_sync("FileType.get_default_extension", [id]);
    ...
    {
	json_call_ajax_async(_url,"FileType.get_default_extension", [id], 1, _callback, _error_callback)
    }

    this.get_default_extensions = function(ids)
    {
	var resp = json_call_ajax_sync(_url,"FileType.get_default_extensions", [ids]);
//	var resp = json_call_sync("FileType.get_default_extensions", [ids]);
    ...
    {
	json_call_ajax_async(_url,"FileType.get_default_extensions", [ids], 1, _callback, _error_callback)
    }

    this.get_file_type_property = function(id, key)
    {
	var resp = json_call_ajax_sync(_url,"FileType.get_file_type_property", [id, key]);
//	var resp = json_call_sync("FileType.get_file_type_property", [id, key]);
    ...
    {
	json_call_ajax_async(_url,"FileType.get_file_type_property", [id, key], 1, _callback, _error_callback)
    }

    this.get_file_type_id_by_full_name = function(name)
    {
	var resp = json_call_ajax_sync(_url,"FileType.get_file_type_id_by_full_name", [name]);
//	var resp = json_call_sync("FileType.get_file_type_id_by_full_name", [name]);
    ...
    {
	json_call_ajax_async(_url,"FileType.get_file_type_id_by_full_name", [name], 1, _callback, _error_callback)
    }

    this.get_possible_file_type_by_extension = function(extension)
    {
	var resp = json_call_ajax_sync(_url,"FileType.get_possible_file_type_by_extension", [extension]);
//	var resp = json_call_sync("FileType.get_possible_file_type_by_extension", [extension]);
    ...
    {
	json_call_ajax_async(_url,"FileType.get_possible_file_type_by_extension", [extension], 1, _callback, _error_callback)
    }

    this.get_possible_file_type_by_default_extension = function(extension)
    {
	var resp = json_call_ajax_sync(_url,"FileType.get_possible_file_type_by_default_extension", [extension]);
//	var resp = json_call_sync("FileType.get_possible_file_type_by_default_extension", [extension]);
    ...
    {
	json_call_ajax_async(_url,"FileType.get_possible_file_type_by_default_extension", [extension], 1, _callback, _error_callback)
    }

    this.get_parent = function(id)
    {
	var resp = json_call_ajax_sync(_url,"FileType.get_parent", [id]);
//	var resp = json_call_sync("FileType.get_parent", [id]);
    ...
    {
	json_call_ajax_async(_url,"FileType.get_parent", [id], 1, _callback, _error_callback)
    }

    this.get_all_children = function(id)
    {
	var resp = json_call_ajax_sync(_url,"FileType.get_all_children", [id]);
//	var resp = json_call_sync("FileType.get_all_children", [id]);
    ...
    {
	json_call_ajax_async(_url,"FileType.get_all_children", [id], 1, _callback, _error_callback)
    }

    this.get_ancestry = function(id)
    {
	var resp = json_call_ajax_sync(_url,"FileType.get_ancestry", [id]);
//	var resp = json_call_sync("FileType.get_ancestry", [id]);
    ...
    {
	json_call_ajax_async(_url,"FileType.get_ancestry", [id], 1, _callback, _error_callback)
    }

    this.get_all_descendants = function(id)
    {
	var resp = json_call_ajax_sync(_url,"FileType.get_all_descendants", [id]);
//	var resp = json_call_sync("FileType.get_all_descendants", [id]);
    ...
    {
	json_call_ajax_async(_url,"FileType.get_all_descendants", [id], 1, _callback, _error_callback)
    }

    this.dump_file_type_hierarchy_in_newick = function()
    {
	var resp = json_call_ajax_sync(_url,"FileType.dump_file_type_hierarchy_in_newick", []);
//	var resp = json_call_sync("FileType.dump_file_type_hierarchy_in_newick", []);
    ...
    {
	json_call_ajax_async(_url,"FileType.dump_file_type_hierarchy_in_newick", [], 1, _callback, _error_callback)
    }

    this.dump_file_type_hierarchy_pretty = function()
    {
	var resp = json_call_ajax_sync(_url,"FileType.dump_file_type_hierarchy_pretty", []);
//	var resp = json_call_sync("FileType.dump_file_type_hierarchy_pretty", []);
    ...
    {
	json_call_ajax_async(_url,"FileType.dump_file_type_hierarchy_pretty", [], 1, _callback, _error_callback)
    }

    this.all_file_type_ids = function()
    {
	var resp = json_call_ajax_sync(_url,"FileType.all_file_type_ids", []);
//	var resp = json_call_sync("FileType.all_file_type_ids", []);
    ...
    {
	json_call_ajax_async(_url,"FileType.all_file_type_ids", [], 1, _callback, _error_callback)
    }

    this.all_file_type_property = function(propertyName)
    {
	var resp = json_call_ajax_sync(_url,"FileType.all_file_type_property", [propertyName]);
//	var resp = json_call_sync("FileType.all_file_type_property", [propertyName]);
    ...
    {
	json_call_ajax_async(_url,"FileType.all_file_type_property", [propertyName], 1, _callback, _error_callback)
    }
...
function Ontology(url) {
    ...
    {
	var resp = json_call_ajax_sync(_url,"Ontology.getGOIDList", [sname, geneIDList, domainList, ecList]);
//	var resp = json_call_sync("Ontology.getGOIDList", [sname, geneIDList, domainList, ecList]);
    ...
    {
	json_call_ajax_async(_url,"Ontology.getGOIDList", [sname, geneIDList, domainList, ecList], 1, _callback, _error_callback)
    }

    this.getGoDesc = function(goIDList)
    {
	var resp = json_call_ajax_sync(_url,"Ontology.getGoDesc", [goIDList]);
//	var resp = json_call_sync("Ontology.getGoDesc", [goIDList]);
    ...
    {
	json_call_ajax_async(_url,"Ontology.getGoDesc", [goIDList], 1, _callback, _error_callback)
    }

    this.getGOEnrichment = function(sname, geneIDList, domainList, ecList, type)
    {
	var resp = json_call_ajax_sync(_url,"Ontology.getGOEnrichment", [sname, geneIDList, domainList, ecList, type]);
//	var resp = json_call_sync("Ontology.getGOEnrichment", [sname, geneIDList, domainList, ecList, type]);
    ...
    {
	json_call_ajax_async(_url,"Ontology.getGOEnrichment", [sname, geneIDList, domainList, ecList, type], 1, _callback, _error_callback)
    }
...
function workspaceService(url) {
    ...
    {
	var resp = json_call_ajax_sync(_url, "workspaceService.save_object", [params]);
//	var resp = json_call_sync("workspaceService.save_object", [params]);
    ...
    {
	json_call_ajax_async(_url, "workspaceService.save_object", [params], 1, _callback, _error_callback)
    }

    this.delete_object = function(params)
    {
	var resp = json_call_ajax_sync(_url, "workspaceService.delete_object", [params]);
//	var resp = json_call_sync("workspaceService.delete_object", [params]);
    ...
    {
	json_call_ajax_async(_url, "workspaceService.delete_object", [params], 1, _callback, _error_callback)
    }

    this.delete_object_permanently = function(params)
    {
	var resp = json_call_ajax_sync(_url, "workspaceService.delete_object_permanently", [params]);
//	var resp = json_call_sync("workspaceService.delete_object_permanently", [params]);
    ...
    {
	json_call_ajax_async(_url, "workspaceService.delete_object_permanently", [params], 1, _callback, _error_callback)
    }

    this.get_object = function(params)
    {
	var resp = json_call_ajax_sync(_url, "workspaceService.get_object", [params]);
//	var resp = json_call_sync("workspaceService.get_object", [params]);
    ...
    {
	json_call_ajax_async(_url, "workspaceService.get_object", [params], 1, _callback, _error_callback)
    }

    this.get_object_by_ref = function(params)
    {
	var resp = json_call_ajax_sync(_url, "workspaceService.get_object_by_ref", [params]);
//	var resp = json_call_sync("workspaceService.get_object_by_ref", [params]);
    ...
    {
	json_call_ajax_async(_url, "workspaceService.get_object_by_ref", [params], 1, _callback, _error_callback)
    }

    this.save_object_by_ref = function(params)
    {
	var resp = json_call_ajax_sync(_url, "workspaceService.save_object_by_ref", [params]);
//	var resp = json_call_sync("workspaceService.save_object_by_ref", [params]);
    ...
    {
	json_call_ajax_async(_url, "workspaceService.save_object_by_ref", [params], 1, _callback, _error_callback)
    }

    this.get_objectmeta = function(params)
    {
	var resp = json_call_ajax_sync(_url, "workspaceService.get_objectmeta", [params]);
//	var resp = json_call_sync("workspaceService.get_objectmeta", [params]);
    ...
    {
	json_call_ajax_async(_url, "workspaceService.get_objectmeta", [params], 1, _callback, _error_callback)
    }

    this.get_objectmeta_by_ref = function(params)
    {
	var resp = json_call_ajax_sync(_url, "workspaceService.get_objectmeta_by_ref", [params]);
//	var resp = json_call_sync("workspaceService.get_objectmeta_by_ref", [params]);
    ...
    {
	json_call_ajax_async(_url, "workspaceService.get_objectmeta_by_ref", [params], 1, _callback, _error_callback)
    }

    this.revert_object = function(params)
    {
	var resp = json_call_ajax_sync(_url, "workspaceService.revert_object", [params]);
//	var resp = json_call_sync("workspaceService.revert_object", [params]);
    ...
    {
	json_call_ajax_async(_url, "workspaceService.revert_object", [params], 1, _callback, _error_callback)
    }

    this.copy_object = function(params)
    {
	var resp = json_call_ajax_sync(_url, "workspaceService.copy_object", [params]);
//	var resp = json_call_sync("workspaceService.copy_object", [params]);
    ...
    {
	json_call_ajax_async(_url, "workspaceService.copy_object", [params], 1, _callback, _error_callback)
    }

    this.move_object = function(params)
    {
	var resp = json_call_ajax_sync(_url, "workspaceService.move_object", [params]);
//	var resp = json_call_sync("workspaceService.move_object", [params]);
    ...
    {
	json_call_ajax_async(_url, "workspaceService.move_object", [params], 1, _callback, _error_callback)
    }

    this.has_object = function(params)
    {
	var resp = json_call_ajax_sync(_url, "workspaceService.has_object", [params]);
//	var resp = json_call_sync("workspaceService.has_object", [params]);
    ...
    {
	json_call_ajax_async(_url, "workspaceService.has_object", [params], 1, _callback, _error_callback)
    }

    this.object_history = function(params)
    {
	var resp = json_call_ajax_sync(_url, "workspaceService.object_history", [params]);
//	var resp = json_call_sync("workspaceService.object_history", [params]);
    ...
    {
	json_call_ajax_async(_url, "workspaceService.object_history", [params], 1, _callback, _error_callback)
    }

    this.create_workspace = function(params)
    {
	var resp = json_call_ajax_sync(_url, "workspaceService.create_workspace", [params]);
//	var resp = json_call_sync("workspaceService.create_workspace", [params]);
    ...
    {
	json_call_ajax_async(_url, "workspaceService.create_workspace", [params], 1, _callback, _error_callback)
    }

    this.get_workspacemeta = function(params)
    {
	var resp = json_call_ajax_sync(_url, "workspaceService.get_workspacemeta", [params]);
//	var resp = json_call_sync("workspaceService.get_workspacemeta", [params]);
    ...
    {
	json_call_ajax_async(_url, "workspaceService.get_workspacemeta", [params], 1, _callback, _error_callback)
    }

    this.get_workspacepermissions = function(params)
    {
	var resp = json_call_ajax_sync(_url, "workspaceService.get_workspacepermissions", [params]);
//	var resp = json_call_sync("workspaceService.get_workspacepermissions", [params]);
    ...
    {
	json_call_ajax_async(_url, "workspaceService.get_workspacepermissions", [params], 1, _callback, _error_callback)
    }

    this.delete_workspace = function(params)
    {
	var resp = json_call_ajax_sync(_url, "workspaceService.delete_workspace", [params]);
//	var resp = json_call_sync("workspaceService.delete_workspace", [params]);
    ...
    {
	json_call_ajax_async(_url, "workspaceService.delete_workspace", [params], 1, _callback, _error_callback)
    }

    this.clone_workspace = function(params)
    {
	var resp = json_call_ajax_sync(_url, "workspaceService.clone_workspace", [params]);
//	var resp = json_call_sync("workspaceService.clone_workspace", [params]);
    ...
    {
	json_call_ajax_async(_url, "workspaceService.clone_workspace", [params], 1, _callback, _error_callback)
    }

    this.list_workspaces = function(params)
    {
	var resp = json_call_ajax_sync(_url, "workspaceService.list_workspaces", [params]);
//	var resp = json_call_sync("workspaceService.list_workspaces", [params]);
    ...
    {
	json_call_ajax_async(_url, "workspaceService.list_workspaces", [params], 1, _callback, _error_callback)
    }

    this.list_workspace_objects = function(params)
    {
	var resp = json_call_ajax_sync(_url, "workspaceService.list_workspace_objects", [params]);
//	var resp = json_call_sync("workspaceService.list_workspace_objects", [params]);
    ...
    {
	json_call_ajax_async(_url, "workspaceService.list_workspace_objects", [params], 1, _callback, _error_callback)
    }

    this.set_global_workspace_permissions = function(params)
    {
	var resp = json_call_ajax_sync(_url, "workspaceService.set_global_workspace_permissions", [params]);
//	var resp = json_call_sync("workspaceService.set_global_workspace_permissions", [params]);
    ...
    {
	json_call_ajax_async(_url, "workspaceService.set_global_workspace_permissions", [params], 1, _callback, _error_callback)
    }

    this.set_workspace_permissions = function(params)
    {
	var resp = json_call_ajax_sync(_url, "workspaceService.set_workspace_permissions", [params]);
//	var resp = json_call_sync("workspaceService.set_workspace_permissions", [params]);
    ...
    {
	json_call_ajax_async(_url, "workspaceService.set_workspace_permissions", [params], 1, _callback, _error_callback)
    }

    this.get_user_settings = function(params)
    {
	var resp = json_call_ajax_sync(_url, "workspaceService.get_user_settings", [params]);
//	var resp = json_call_sync("workspaceService.get_user_settings", [params]);
    ...
    {
	json_call_ajax_async(_url, "workspaceService.get_user_settings", [params], 1, _callback, _error_callback)
    }

    this.set_user_settings = function(params)
    {
	var resp = json_call_ajax_sync(_url, "workspaceService.set_user_settings", [params]);
//	var resp = json_call_sync("workspaceService.set_user_settings", [params]);
    ...
    {
	json_call_ajax_async(_url, "workspaceService.set_user_settings", [params], 1, _callback, _error_callback)
    }

    this.queue_job = function(params)
    {
	var resp = json_call_ajax_sync(_url, "workspaceService.queue_job", [params]);
//	var resp = json_call_sync("workspaceService.queue_job", [params]);
    ...
    {
	json_call_ajax_async(_url, "workspaceService.queue_job", [params], 1, _callback, _error_callback)
    }

    this.set_job_status = function(params)
    {
	var resp = json_call_ajax_sync(_url, "workspaceService.set_job_status", [params]);
//	var resp = json_call_sync("workspaceService.set_job_status", [params]);
    ...
    {
	json_call_ajax_async(_url, "workspaceService.set_job_status", [params], 1, _callback, _error_callback)
    }

    this.get_jobs = function(params)
    {
	var resp = json_call_ajax_sync(_url, "workspaceService.get_jobs", [params]);
//	var resp = json_call_sync("workspaceService.get_jobs", [params]);
    ...
    {
	json_call_ajax_async(_url, "workspaceService.get_jobs", [params], 1, _callback, _error_callback)
    }

    this.get_types = function()
    {
	var resp = json_call_ajax_sync(_url, "workspaceService.get_types", []);
//	var resp = json_call_sync("workspaceService.get_types", []);
    ...
    {
	json_call_ajax_async(_url, "workspaceService.get_types", [], 1, _callback, _error_callback)
    }

    this.add_type = function(params)
    {
	var resp = json_call_ajax_sync(_url, "workspaceService.add_type", [params]);
//	var resp = json_call_sync("workspaceService.add_type", [params]);
    ...
    {
	json_call_ajax_async(_url, "workspaceService.add_type", [params], 1, _callback, _error_callback)
    }

    this.remove_type = function(params)
    {
	var resp = json_call_ajax_sync(_url, "workspaceService.remove_type", [params]);
//	var resp = json_call_sync("workspaceService.remove_type", [params]);
    ...
    {
	json_call_ajax_async(_url, "workspaceService.remove_type", [params], 1, _callback, _error_callback)
    }
...
function Tree(url) {
    ...
    {
	var resp = json_call_ajax_sync(_url,"Tree.replace_node_names", [tree, replacements]);
//	var resp = json_call_sync("Tree.replace_node_names", [tree, replacements]);
    ...
    {
	json_call_ajax_async(_url,"Tree.replace_node_names", [tree, replacements], 1, _callback, _error_callback)
    }

    this.remove_node_names_and_simplify = function(tree, removal_list)
    {
	var resp = json_call_ajax_sync(_url,"Tree.remove_node_names_and_simplify", [tree, removal_list]);
//	var resp = json_call_sync("Tree.remove_node_names_and_simplify", [tree, removal_list]);
    ...
    {
	json_call_ajax_async(_url,"Tree.remove_node_names_and_simplify", [tree, removal_list], 1, _callback, _error_callback)
    }

    this.extract_leaf_node_names = function(tree)
    {
	var resp = json_call_ajax_sync(_url,"Tree.extract_leaf_node_names", [tree]);
//	var resp = json_call_sync("Tree.extract_leaf_node_names", [tree]);
    ...
    {
	json_call_ajax_async(_url,"Tree.extract_leaf_node_names", [tree], 1, _callback, _error_callback)
    }

    this.extract_node_names = function(tree)
    {
	var resp = json_call_ajax_sync(_url,"Tree.extract_node_names", [tree]);
//	var resp = json_call_sync("Tree.extract_node_names", [tree]);
    ...
    {
	json_call_ajax_async(_url,"Tree.extract_node_names", [tree], 1, _callback, _error_callback)
    }

    this.get_node_count = function(tree)
    {
	var resp = json_call_ajax_sync(_url,"Tree.get_node_count", [tree]);
//	var resp = json_call_sync("Tree.get_node_count", [tree]);
    ...
    {
	json_call_ajax_async(_url,"Tree.get_node_count", [tree], 1, _callback, _error_callback)
    }

    this.get_leaf_count = function(tree)
    {
	var resp = json_call_ajax_sync(_url,"Tree.get_leaf_count", [tree]);
//	var resp = json_call_sync("Tree.get_leaf_count", [tree]);
    ...
    {
	json_call_ajax_async(_url,"Tree.get_leaf_count", [tree], 1, _callback, _error_callback)
    }

    this.get_tree = function(tree_id, options)
    {
	var resp = json_call_ajax_sync(_url,"Tree.get_tree", [tree_id, options]);
//	var resp = json_call_sync("Tree.get_tree", [tree_id, options]);
    ...
    {
	json_call_ajax_async(_url,"Tree.get_tree", [tree_id, options], 1, _callback, _error_callback)
    }

    this.get_tree_data = function(tree_ids)
    {
	var resp = json_call_ajax_sync(_url,"Tree.get_tree_data", [tree_ids]);
//	var resp = json_call_sync("Tree.get_tree_data", [tree_ids]);
    ...
    {
	json_call_ajax_async(_url,"Tree.get_tree_data", [tree_ids], 1, _callback, _error_callback)
    }

    this.get_alignment_data = function(alignment_ids)
    {
	var resp = json_call_ajax_sync(_url,"Tree.get_alignment_data", [alignment_ids]);
//	var resp = json_call_sync("Tree.get_alignment_data", [alignment_ids]);
    ...
    {
	json_call_ajax_async(_url,"Tree.get_alignment_data", [alignment_ids], 1, _callback, _error_callback)
    }

    this.get_tree_ids_by_feature = function(feature_ids)
    {
	var resp = json_call_ajax_sync(_url,"Tree.get_tree_ids_by_feature", [feature_ids]);
//	var resp = json_call_sync("Tree.get_tree_ids_by_feature", [feature_ids]);
    ...
    {
	json_call_ajax_async(_url,"Tree.get_tree_ids_by_feature", [feature_ids], 1, _callback, _error_callback)
    }

    this.get_tree_ids_by_protein_sequence = function(protein_sequence_ids)
    {
	var resp = json_call_ajax_sync(_url,"Tree.get_tree_ids_by_protein_sequence", [protein_sequence_ids]);
//	var resp = json_call_sync("Tree.get_tree_ids_by_protein_sequence", [protein_sequence_ids]);
    ...
    {
	json_call_ajax_async(_url,"Tree.get_tree_ids_by_protein_sequence", [protein_sequence_ids], 1, _callback, _error_callback)
    }

    this.get_alignment_ids_by_feature = function(feature_ids)
    {
	var resp = json_call_ajax_sync(_url,"Tree.get_alignment_ids_by_feature", [feature_ids]);
//	var resp = json_call_sync("Tree.get_alignment_ids_by_feature", [feature_ids]);
    ...
    {
	json_call_ajax_async(_url,"Tree.get_alignment_ids_by_feature", [feature_ids], 1, _callback, _error_callback)
    }

    this.get_alignment_ids_by_protein_sequence = function(protein_sequence_ids)
    {
	var resp = json_call_ajax_sync(_url,"Tree.get_alignment_ids_by_protein_sequence", [protein_sequence_ids]);
//	var resp = json_call_sync("Tree.get_alignment_ids_by_protein_sequence", [protein_sequence_ids]);
    ...
    {
	json_call_ajax_async(_url,"Tree.get_alignment_ids_by_protein_sequence", [protein_sequence_ids], 1, _callback, _error_callback)
    }

    this.draw_html_tree = function(tree, display_options)
    {
	var resp = json_call_ajax_sync(_url,"Tree.draw_html_tree", [tree, display_options]);
//	var resp = json_call_sync("Tree.draw_html_tree", [tree, display_options]);
    ...
    {
	json_call_ajax_async(_url,"Tree.draw_html_tree", [tree, display_options], 1, _callback, _error_callback)
    }
...
function fbaModelServices(url) {
    ...
    {
	var resp = json_call_ajax_sync(_url,"fbaModelServices.get_models", [input]);
//	var resp = json_call_sync("fbaModelServices.get_models", [input]);
    ...
    {
	json_call_ajax_async(_url,"fbaModelServices.get_models", [input], 1, _callback, _error_callback)
    }

    this.get_fbas = function(input)
    {
	var resp = json_call_ajax_sync(_url,"fbaModelServices.get_fbas", [input]);
//	var resp = json_call_sync("fbaModelServices.get_fbas", [input]);
    ...
    {
	json_call_ajax_async(_url,"fbaModelServices.get_fbas", [input], 1, _callback, _error_callback)
    }

    this.get_gapfills = function(input)
    {
	var resp = json_call_ajax_sync(_url,"fbaModelServices.get_gapfills", [input]);
//	var resp = json_call_sync("fbaModelServices.get_gapfills", [input]);
    ...
    {
	json_call_ajax_async(_url,"fbaModelServices.get_gapfills", [input], 1, _callback, _error_callback)
    }

    this.get_gapgens = function(input)
    {
	var resp = json_call_ajax_sync(_url,"fbaModelServices.get_gapgens", [input]);
//	var resp = json_call_sync("fbaModelServices.get_gapgens", [input]);
    ...
    {
	json_call_ajax_async(_url,"fbaModelServices.get_gapgens", [input], 1, _callback, _error_callback)
    }

    this.get_reactions = function(input)
    {
	var resp = json_call_ajax_sync(_url,"fbaModelServices.get_reactions", [input]);
//	var resp = json_call_sync("fbaModelServices.get_reactions", [input]);
    ...
    {
	json_call_ajax_async(_url,"fbaModelServices.get_reactions", [input], 1, _callback, _error_callback)
    }

    this.get_compounds = function(input)
    {
	var resp = json_call_ajax_sync(_url,"fbaModelServices.get_compounds", [input]);
//	var resp = json_call_sync("fbaModelServices.get_compounds", [input]);
    ...
    {
	json_call_ajax_async(_url,"fbaModelServices.get_compounds", [input], 1, _callback, _error_callback)
    }

    this.get_media = function(input)
    {
	var resp = json_call_ajax_sync(_url,"fbaModelServices.get_media", [input]);
//	var resp = json_call_sync("fbaModelServices.get_media", [input]);
    ...
    {
	json_call_ajax_async(_url,"fbaModelServices.get_media", [input], 1, _callback, _error_callback)
    }

    this.get_biochemistry = function(input)
    {
	var resp = json_call_ajax_sync(_url,"fbaModelServices.get_biochemistry", [input]);
//	var resp = json_call_sync("fbaModelServices.get_biochemistry", [input]);
    ...
    {
	json_call_ajax_async(_url,"fbaModelServices.get_biochemistry", [input], 1, _callback, _error_callback)
    }

    this.genome_object_to_workspace = function(input)
    {
	var resp = json_call_ajax_sync(_url,"fbaModelServices.genome_object_to_workspace", [input]);
//	var resp = json_call_sync("fbaModelServices.genome_object_to_workspace", [input]);
    ...
    {
	json_call_ajax_async(_url,"fbaModelServices.genome_object_to_workspace", [input], 1, _callback, _error_callback)
    }

    this.genome_to_workspace = function(input)
    {
	var resp = json_call_ajax_sync(_url,"fbaModelServices.genome_to_workspace", [input]);
//	var resp = json_call_sync("fbaModelServices.genome_to_workspace", [input]);
    ...
    {
	json_call_ajax_async(_url,"fbaModelServices.genome_to_workspace", [input], 1, _callback, _error_callback)
    }

    this.add_feature_translation = function(input)
    {
	var resp = json_call_ajax_sync(_url,"fbaModelServices.add_feature_translation", [input]);
//	var resp = json_call_sync("fbaModelServices.add_feature_translation", [input]);
    ...
    {
	json_call_ajax_async(_url,"fbaModelServices.add_feature_translation", [input], 1, _callback, _error_callback)
    }

    this.genome_to_fbamodel = function(input)
    {
	var resp = json_call_ajax_sync(_url,"fbaModelServices.genome_to_fbamodel", [input]);
//	var resp = json_call_sync("fbaModelServices.genome_to_fbamodel", [input]);
    ...
    {
	json_call_ajax_async(_url,"fbaModelServices.genome_to_fbamodel", [input], 1, _callback, _error_callback)
    }

    this.export_fbamodel = function(input)
    {
	var resp = json_call_ajax_sync(_url,"fbaModelServices.export_fbamodel", [input]);
//	var resp = json_call_sync("fbaModelServices.export_fbamodel", [input]);
    ...
    {
	json_call_ajax_async(_url,"fbaModelServices.export_fbamodel", [input], 1, _callback, _error_callback)
    }

    this.adjust_model_reaction = function(input)
    {
	var resp = json_call_ajax_sync(_url,"fbaModelServices.adjust_model_reaction", [input]);
//	var resp = json_call_sync("fbaModelServices.adjust_model_reaction", [input]);
    ...
    {
	json_call_ajax_async(_url,"fbaModelServices.adjust_model_reaction", [input], 1, _callback, _error_callback)
    }

    this.adjust_biomass_reaction = function(input)
    {
	var resp = json_call_ajax_sync(_url,"fbaModelServices.adjust_biomass_reaction", [input]);
//	var resp = json_call_sync("fbaModelServices.adjust_biomass_reaction", [input]);
    ...
    {
	json_call_ajax_async(_url,"fbaModelServices.adjust_biomass_reaction", [input], 1, _callback, _error_callback)
    }

    this.addmedia = function(input)
    {
	var resp = json_call_ajax_sync(_url,"fbaModelServices.addmedia", [input]);
//	var resp = json_call_sync("fbaModelServices.addmedia", [input]);
    ...
    {
	json_call_ajax_async(_url,"fbaModelServices.addmedia", [input], 1, _callback, _error_callback)
    }

    this.export_media = function(input)
    {
	var resp = json_call_ajax_sync(_url,"fbaModelServices.export_media", [input]);
//	var resp = json_call_sync("fbaModelServices.export_media", [input]);
    ...
    {
	json_call_ajax_async(_url,"fbaModelServices.export_media", [input], 1, _callback, _error_callback)
    }

    this.runfba = function(input)
    {
	var resp = json_call_ajax_sync(_url,"fbaModelServices.runfba", [input]);
//	var resp = json_call_sync("fbaModelServices.runfba", [input]);
    ...
    {
	json_call_ajax_async(_url,"fbaModelServices.runfba", [input], 1, _callback, _error_callback)
    }

    this.export_fba = function(input)
    {
	var resp = json_call_ajax_sync(_url,"fbaModelServices.export_fba", [input]);
//	var resp = json_call_sync("fbaModelServices.export_fba", [input]);
    ...
    {
	json_call_ajax_async(_url,"fbaModelServices.export_fba", [input], 1, _callback, _error_callback)
    }

    this.import_phenotypes = function(input)
    {
	var resp = json_call_ajax_sync(_url,"fbaModelServices.import_phenotypes", [input]);
//	var resp = json_call_sync("fbaModelServices.import_phenotypes", [input]);
    ...
    {
	json_call_ajax_async(_url,"fbaModelServices.import_phenotypes", [input], 1, _callback, _error_callback)
    }

    this.simulate_phenotypes = function(input)
    {
	var resp = json_call_ajax_sync(_url,"fbaModelServices.simulate_phenotypes", [input]);
//	var resp = json_call_sync("fbaModelServices.simulate_phenotypes", [input]);
    ...
    {
	json_call_ajax_async(_url,"fbaModelServices.simulate_phenotypes", [input], 1, _callback, _error_callback)
    }

    this.export_phenotypeSimulationSet = function(input)
    {
	var resp = json_call_ajax_sync(_url,"fbaModelServices.export_phenotypeSimulationSet", [input]);
//	var resp = json_call_sync("fbaModelServices.export_phenotypeSimulationSet", [input]);
    ...
    {
	json_call_ajax_async(_url,"fbaModelServices.export_phenotypeSimulationSet", [input], 1, _callback, _error_callback)
    }

    this.integrate_reconciliation_solutions = function(input)
    {
	var resp = json_call_ajax_sync(_url,"fbaModelServices.integrate_reconciliation_solutions", [input]);
//	var resp = json_call_sync("fbaModelServices.integrate_reconciliation_solutions", [input]);
    ...
    {
	json_call_ajax_async(_url,"fbaModelServices.integrate_reconciliation_solutions", [input], 1, _callback, _error_callback)
    }

    this.queue_runfba = function(input)
    {
	var resp = json_call_ajax_sync(_url,"fbaModelServices.queue_runfba", [input]);
//	var resp = json_call_sync("fbaModelServices.queue_runfba", [input]);
    ...
    {
	json_call_ajax_async(_url,"fbaModelServices.queue_runfba", [input], 1, _callback, _error_callback)
    }

    this.queue_gapfill_model = function(input)
    {
	var resp = json_call_ajax_sync(_url,"fbaModelServices.queue_gapfill_model", [input]);
//	var resp = json_call_sync("fbaModelServices.queue_gapfill_model", [input]);
    ...
    {
	json_call_ajax_async(_url,"fbaModelServices.queue_gapfill_model", [input], 1, _callback, _error_callback)
    }

    this.queue_gapgen_model = function(input)
    {
	var resp = json_call_ajax_sync(_url,"fbaModelServices.queue_gapgen_model", [input]);
//	var resp = json_call_sync("fbaModelServices.queue_gapgen_model", [input]);
    ...
    {
	json_call_ajax_async(_url,"fbaModelServices.queue_gapgen_model", [input], 1, _callback, _error_callback)
    }

    this.queue_wildtype_phenotype_reconciliation = function(input)
    {
	var resp = json_call_ajax_sync(_url,"fbaModelServices.queue_wildtype_phenotype_reconciliation", [input]);
//	var resp = json_call_sync("fbaModelServices.queue_wildtype_phenotype_reconciliation", [input]);
    ...
    {
	json_call_ajax_async(_url,"fbaModelServices.queue_wildtype_phenotype_reconciliation", [input], 1, _callback, _error_callback)
    }

    this.queue_reconciliation_sensitivity_analysis = function(input)
    {
	var resp = json_call_ajax_sync(_url,"fbaModelServices.queue_reconciliation_sensitivity_analysis", [input]);
//	var resp = json_call_sync("fbaModelServices.queue_reconciliation_sensitivity_analysis", [input]);
    ...
    {
	json_call_ajax_async(_url,"fbaModelServices.queue_reconciliation_sensitivity_analysis", [input], 1, _callback, _error_callback)
    }

    this.queue_combine_wildtype_phenotype_reconciliation = function(input)
    {
	var resp = json_call_ajax_sync(_url,"fbaModelServices.queue_combine_wildtype_phenotype_reconciliation", [input]);
//	var resp = json_call_sync("fbaModelServices.queue_combine_wildtype_phenotype_reconciliation", [input]);
    ...
    {
	json_call_ajax_async(_url,"fbaModelServices.queue_combine_wildtype_phenotype_reconciliation", [input], 1, _callback, _error_callback)
    }

    this.jobs_done = function(input)
    {
	var resp = json_call_ajax_sync(_url,"fbaModelServices.jobs_done", [input]);
//	var resp = json_call_sync("fbaModelServices.jobs_done", [input]);
    ...
    {
	json_call_ajax_async(_url,"fbaModelServices.jobs_done", [input], 1, _callback, _error_callback)
    }

    this.check_job = function(input)
    {
	var resp = json_call_ajax_sync(_url,"fbaModelServices.check_job", [input]);
//	var resp = json_call_sync("fbaModelServices.check_job", [input]);
    ...
    {
	json_call_ajax_async(_url,"fbaModelServices.check_job", [input], 1, _callback, _error_callback)
    }

    this.run_job = function(input)
    {
	var resp = json_call_ajax_sync(_url,"fbaModelServices.run_job", [input]);
//	var resp = json_call_sync("fbaModelServices.run_job", [input]);
    ...
    {
	json_call_ajax_async(_url,"fbaModelServices.run_job", [input], 1, _callback, _error_callback)
    }
...
function ERDB_Service(url) {
    ...
    {
	var resp = json_call_ajax_sync(_url,"ERDB_Service.GetAll", [objectNames, filterClause, parameters, fields, count]);
//	var resp = json_call_sync("ERDB_Service.GetAll", [objectNames, filterClause, parameters, fields, count]);
    ...
    {
	json_call_ajax_async(_url,"ERDB_Service.GetAll", [objectNames, filterClause, parameters, fields, count], 1, _callback, _error_callback)
    }

    this.runSQL = function(SQLstring, parameters)
    {
	var resp = json_call_ajax_sync(_url,"ERDB_Service.runSQL", [SQLstring, parameters]);
//	var resp = json_call_sync("ERDB_Service.runSQL", [SQLstring, parameters]);
    ...
    {
	json_call_ajax_async(_url,"ERDB_Service.runSQL", [SQLstring, parameters], 1, _callback, _error_callback)
    }
...
//	var resp = json_call_sync("CDMI_API.fids_to_atomic_regulons", [fids]);
    ...
    {
	var resp = json_call_ajax_sync(_url,"CDMI_API.atomic_regulons_to_fids", [regulons]);
//	var resp = json_call_sync("CDMI_API.atomic_regulons_to_fids", [regulons]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_API.atomic_regulons_to_fids", [regulons], 1, _callback, _error_callback)
    }
...
function CDMI_EntityAPI(url) {
    ...
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_AlignmentTree", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_AlignmentTree", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_AlignmentTree", [ids, fields], 1, _callback, _error_callback)
    }

    this.all_entities_AlignmentTree = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_AlignmentTree", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_AlignmentTree", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_AlignmentTree", [start, count, fields], 1, _callback, _error_callback)
    }
...
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Biomass", [start, count, fields]);
    ...
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_BiomassCompound", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_BiomassCompound", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_BiomassCompound", [ids, fields], 1, _callback, _error_callback)
    }

    this.all_entities_BiomassCompound = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_BiomassCompound", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_BiomassCompound", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_BiomassCompound", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Compartment = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Compartment", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Compartment", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Compartment", [ids, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Compartment = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Compartment", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Compartment", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Compartment", [start, count, fields], 1, _callback, _error_callback)
    }
...
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Genome", [start, count, fields]);
    ...
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Identifier", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Identifier", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Identifier", [ids, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Identifier = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Identifier", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Identifier", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Identifier", [start, count, fields], 1, _callback, _error_callback)
    }
...
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Model", [start, count, fields]);
    ...
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_ModelCompartment", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_ModelCompartment", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_ModelCompartment", [ids, fields], 1, _callback, _error_callback)
    }

    this.all_entities_ModelCompartment = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_ModelCompartment", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_ModelCompartment", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_ModelCompartment", [start, count, fields], 1, _callback, _error_callback)
    }
...
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Reaction", [start, count, fields]);
    ...
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_ReactionRule", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_ReactionRule", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_ReactionRule", [ids, fields], 1, _callback, _error_callback)
    }

    this.all_entities_ReactionRule = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_ReactionRule", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_ReactionRule", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_ReactionRule", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Reagent = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Reagent", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Reagent", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Reagent", [ids, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Reagent = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Reagent", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Reagent", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Reagent", [start, count, fields], 1, _callback, _error_callback)
    }

    this.get_entity_Requirement = function(ids, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Requirement", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Requirement", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Requirement", [ids, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Requirement = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Requirement", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Requirement", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Requirement", [start, count, fields], 1, _callback, _error_callback)
    }
...
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Variant", [start, count, fields]);
    ...
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_entity_Variation", [ids, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_entity_Variation", [ids, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_entity_Variation", [ids, fields], 1, _callback, _error_callback)
    }

    this.all_entities_Variation = function(start, count, fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.all_entities_Variation", [start, count, fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.all_entities_Variation", [start, count, fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.all_entities_Variation", [start, count, fields], 1, _callback, _error_callback)
    }
...
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsAffectedIn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_Aligns", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Aligns", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_Aligns", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsAlignedBy = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsAlignedBy", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsAlignedBy", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsAlignedBy", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }
...
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_WasGeneratedFrom", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasAssertionFrom", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasAssertionFrom", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasAssertionFrom", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_Asserts = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_Asserts", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Asserts", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_Asserts", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }
...
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsInvolvedIn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsARequirementIn", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsARequirementIn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsARequirementIn", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }
...
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsARequirementOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsAlignedIn", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsAlignedIn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsAlignedIn", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsAlignmentFor = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsAlignmentFor", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsAlignmentFor", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsAlignmentFor", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }
...
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Annotates", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsBindingSiteFor", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsBindingSiteFor", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsBindingSiteFor", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsBoundBy = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsBoundBy", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsBoundBy", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsBoundBy", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }
...
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsCoupledWith", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsDefaultFor", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsDefaultFor", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsDefaultFor", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_RunsByDefaultIn = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_RunsByDefaultIn", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_RunsByDefaultIn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_RunsByDefaultIn", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsDefaultLocationOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsDefaultLocationOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsDefaultLocationOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsDefaultLocationOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasDefaultLocation = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasDefaultLocation", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasDefaultLocation", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasDefaultLocation", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }
...
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Models", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsNamedBy", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsNamedBy", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsNamedBy", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_Names = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_Names", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Names", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_Names", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }
...
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsOwnedBy", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsProposedLocationOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsProposedLocationOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsProposedLocationOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_HasProposedLocationIn = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_HasProposedLocationIn", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HasProposedLocationIn", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_HasProposedLocationIn", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }
...
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsRelevantTo", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsRequiredBy", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsRequiredBy", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsRequiredBy", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_Requires = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_Requires", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Requires", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_Requires", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }
...
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsSubclassOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsTargetOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsTargetOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsTargetOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }
...
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_Triggers", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsUsedAs", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsUsedAs", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsUsedAs", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsUseOf = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsUseOf", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsUseOf", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsUseOf", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }
...
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_HadResultsProducedBy", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_ProjectsOnto", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_ProjectsOnto", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_ProjectsOnto", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }

    this.get_relationship_IsProjectedOnto = function(ids, from_fields, rel_fields, to_fields)
    {
	var resp = json_call_ajax_sync(_url,"CDMI_EntityAPI.get_relationship_IsProjectedOnto", [ids, from_fields, rel_fields, to_fields]);
//	var resp = json_call_sync("CDMI_EntityAPI.get_relationship_IsProjectedOnto", [ids, from_fields, rel_fields, to_fields]);
    ...
    {
	json_call_ajax_async(_url,"CDMI_EntityAPI.get_relationship_IsProjectedOnto", [ids, from_fields, rel_fields, to_fields], 1, _callback, _error_callback)
    }
...
function KBaseNetworks(url) {
    ...
    {
	var resp = json_call_ajax_sync(_url,"KBaseNetworks.allDatasets", []);
//	var resp = json_call_sync("KBaseNetworks.allDatasets", []);
    ...
    {
	json_call_ajax_async(_url,"KBaseNetworks.allDatasets", [], 1, _callback, _error_callback)
    }

    this.allDatasetSources = function()
    {
	var resp = json_call_ajax_sync(_url,"KBaseNetworks.allDatasetSources", []);
//	var resp = json_call_sync("KBaseNetworks.allDatasetSources", []);
    ...
    {
	json_call_ajax_async(_url,"KBaseNetworks.allDatasetSources", [], 1, _callback, _error_callback)
    }

    this.allNetworkTypes = function()
    {
	var resp = json_call_ajax_sync(_url,"KBaseNetworks.allNetworkTypes", []);
//	var resp = json_call_sync("KBaseNetworks.allNetworkTypes", []);
    ...
    {
	json_call_ajax_async(_url,"KBaseNetworks.allNetworkTypes", [], 1, _callback, _error_callback)
    }

    this.datasetSource2Datasets = function(datasetSourceRef)
    {
	var resp = json_call_ajax_sync(_url,"KBaseNetworks.datasetSource2Datasets", [datasetSourceRef]);
//	var resp = json_call_sync("KBaseNetworks.datasetSource2Datasets", [datasetSourceRef]);
    ...
    {
	json_call_ajax_async(_url,"KBaseNetworks.datasetSource2Datasets", [datasetSourceRef], 1, _callback, _error_callback)
    }

    this.taxon2Datasets = function(taxon)
    {
	var resp = json_call_ajax_sync(_url,"KBaseNetworks.taxon2Datasets", [taxon]);
//	var resp = json_call_sync("KBaseNetworks.taxon2Datasets", [taxon]);
    ...
    {
	json_call_ajax_async(_url,"KBaseNetworks.taxon2Datasets", [taxon], 1, _callback, _error_callback)
    }

    this.networkType2Datasets = function(networkType)
    {
	var resp = json_call_ajax_sync(_url,"KBaseNetworks.networkType2Datasets", [networkType]);
//	var resp = json_call_sync("KBaseNetworks.networkType2Datasets", [networkType]);
    ...
    {
	json_call_ajax_async(_url,"KBaseNetworks.networkType2Datasets", [networkType], 1, _callback, _error_callback)
    }

    this.entity2Datasets = function(entityId)
    {
	var resp = json_call_ajax_sync(_url,"KBaseNetworks.entity2Datasets", [entityId]);
//	var resp = json_call_sync("KBaseNetworks.entity2Datasets", [entityId]);
    ...
    {
	json_call_ajax_async(_url,"KBaseNetworks.entity2Datasets", [entityId], 1, _callback, _error_callback)
    }

    this.buildFirstNeighborNetwork = function(datasetIds, entityIds, edgeTypes)
    {
	var resp = json_call_ajax_sync(_url,"KBaseNetworks.buildFirstNeighborNetwork", [datasetIds, entityIds, edgeTypes]);
//	var resp = json_call_sync("KBaseNetworks.buildFirstNeighborNetwork", [datasetIds, entityIds, edgeTypes]);
    ...
    {
	json_call_ajax_async(_url,"KBaseNetworks.buildFirstNeighborNetwork", [datasetIds, entityIds, edgeTypes], 1, _callback, _error_callback)
    }

    this.buildFirstNeighborNetworkLimtedByStrength = function(datasetIds, entityIds, edgeTypes, cutOff)
    {
	var resp = json_call_ajax_sync(_url,"KBaseNetworks.buildFirstNeighborNetworkLimtedByStrength", [datasetIds, entityIds, edgeTypes, cutOff]);
//	var resp = json_call_sync("KBaseNetworks.buildFirstNeighborNetworkLimtedByStrength", [datasetIds, entityIds, edgeTypes, cutOff]);
    ...
    {
	json_call_ajax_async(_url,"KBaseNetworks.buildFirstNeighborNetworkLimtedByStrength", [datasetIds, entityIds, edgeTypes, cutOff], 1, _callback, _error_callback)
    }

    this.buildInternalNetwork = function(datasetIds, geneIds, edgeTypes)
    {
	var resp = json_call_ajax_sync(_url,"KBaseNetworks.buildInternalNetwork", [datasetIds, geneIds, edgeTypes]);
//	var resp = json_call_sync("KBaseNetworks.buildInternalNetwork", [datasetIds, geneIds, edgeTypes]);
    ...
    {
	json_call_ajax_async(_url,"KBaseNetworks.buildInternalNetwork", [datasetIds, geneIds, edgeTypes], 1, _callback, _error_callback)
    }

    this.buildInternalNetworkLimitedByStrength = function(datasetIds, geneIds, edgeTypes, cutOff)
    {
	var resp = json_call_ajax_sync(_url,"KBaseNetworks.buildInternalNetworkLimitedByStrength", [datasetIds, geneIds, edgeTypes, cutOff]);
//	var resp = json_call_sync("KBaseNetworks.buildInternalNetworkLimitedByStrength", [datasetIds, geneIds, edgeTypes, cutOff]);
    ...
    {
	json_call_ajax_async(_url,"KBaseNetworks.buildInternalNetworkLimitedByStrength", [datasetIds, geneIds, edgeTypes, cutOff], 1, _callback, _error_callback)
    }
...
function GenomeAnnotation(url) {
    ...
    {
	var resp = json_call_ajax_sync(_url,"GenomeAnnotation.genomeTO_to_reconstructionTO", [genomeTO]);
//	var resp = json_call_sync("GenomeAnnotation.genomeTO_to_reconstructionTO", [genomeTO]);
    ...
    {
	json_call_ajax_async(_url,"GenomeAnnotation.genomeTO_to_reconstructionTO", [genomeTO], 1, _callback, _error_callback)
    }

    this.genomeTO_to_feature_data = function(genomeTO)
    {
	var resp = json_call_ajax_sync(_url,"GenomeAnnotation.genomeTO_to_feature_data", [genomeTO]);
//	var resp = json_call_sync("GenomeAnnotation.genomeTO_to_feature_data", [genomeTO]);
    ...
    {
	json_call_ajax_async(_url,"GenomeAnnotation.genomeTO_to_feature_data", [genomeTO], 1, _callback, _error_callback)
    }

    this.reconstructionTO_to_roles = function(reconstructionTO)
    {
	var resp = json_call_ajax_sync(_url,"GenomeAnnotation.reconstructionTO_to_roles", [reconstructionTO]);
//	var resp = json_call_sync("GenomeAnnotation.reconstructionTO_to_roles", [reconstructionTO]);
    ...
    {
	json_call_ajax_async(_url,"GenomeAnnotation.reconstructionTO_to_roles", [reconstructionTO], 1, _callback, _error_callback)
    }

    this.reconstructionTO_to_subsystems = function(reconstructionTO)
    {
	var resp = json_call_ajax_sync(_url,"GenomeAnnotation.reconstructionTO_to_subsystems", [reconstructionTO]);
//	var resp = json_call_sync("GenomeAnnotation.reconstructionTO_to_subsystems", [reconstructionTO]);
    ...
    {
	json_call_ajax_async(_url,"GenomeAnnotation.reconstructionTO_to_subsystems", [reconstructionTO], 1, _callback, _error_callback)
    }

    this.annotate_genome = function(genomeTO)
    {
	var resp = json_call_ajax_sync(_url,"GenomeAnnotation.annotate_genome", [genomeTO]);
//	var resp = json_call_sync("GenomeAnnotation.annotate_genome", [genomeTO]);
    ...
    {
	json_call_ajax_async(_url,"GenomeAnnotation.annotate_genome", [genomeTO], 1, _callback, _error_callback)
    }

    this.call_RNAs = function(genomeTO)
    {
	var resp = json_call_ajax_sync(_url,"GenomeAnnotation.call_RNAs", [genomeTO]);
//	var resp = json_call_sync("GenomeAnnotation.call_RNAs", [genomeTO]);
    ...
    {
	json_call_ajax_async(_url,"GenomeAnnotation.call_RNAs", [genomeTO], 1, _callback, _error_callback)
    }

    this.call_CDSs = function(genomeTO)
    {
	var resp = json_call_ajax_sync(_url,"GenomeAnnotation.call_CDSs", [genomeTO]);
//	var resp = json_call_sync("GenomeAnnotation.call_CDSs", [genomeTO]);
    ...
    {
	json_call_ajax_async(_url,"GenomeAnnotation.call_CDSs", [genomeTO], 1, _callback, _error_callback)
    }

    this.find_close_neighbors = function(genomeTO)
    {
	var resp = json_call_ajax_sync(_url,"GenomeAnnotation.find_close_neighbors", [genomeTO]);
//	var resp = json_call_sync("GenomeAnnotation.find_close_neighbors", [genomeTO]);
    ...
    {
	json_call_ajax_async(_url,"GenomeAnnotation.find_close_neighbors", [genomeTO], 1, _callback, _error_callback)
    }

    this.assign_functions_to_CDSs = function(genomeTO)
    {
	var resp = json_call_ajax_sync(_url,"GenomeAnnotation.assign_functions_to_CDSs", [genomeTO]);
//	var resp = json_call_sync("GenomeAnnotation.assign_functions_to_CDSs", [genomeTO]);
    ...
    {
	json_call_ajax_async(_url,"GenomeAnnotation.assign_functions_to_CDSs", [genomeTO], 1, _callback, _error_callback)
    }

    this.annotate_proteins = function(genomeTO)
    {
	var resp = json_call_ajax_sync(_url,"GenomeAnnotation.annotate_proteins", [genomeTO]);
//	var resp = json_call_sync("GenomeAnnotation.annotate_proteins", [genomeTO]);
    ...
    {
	json_call_ajax_async(_url,"GenomeAnnotation.annotate_proteins", [genomeTO], 1, _callback, _error_callback)
    }
...
function Experiment(url) {
    ...
    this.getChildCompounds = function(parents)
    {
	var resp = json_call_ajax_sync(_url,"Experiment.getChildCompounds", [parents]);
//	var resp = json_call_sync("Experiment.getChildCompounds", [parents]);
        return resp[0];
    }

    this.getChildCompounds_async = function(parents, _callback, _error_callback)
    {
	json_call_ajax_async(_url,"Experiment.getChildCompounds", [parents], 1, _callback, _error_callback)
    }

    this.getParentCompounds = function(children)
    {
	var resp = json_call_ajax_sync(_url,"Experiment.getParentCompounds", [children]);
//	var resp = json_call_sync("Experiment.getParentCompounds", [children]);
        return resp[0];
    }

    this.getParentCompounds_async = function(children, _callback, _error_callback)
    {
	json_call_ajax_async(_url,"Experiment.getParentCompounds", [children], 1, _callback, _error_callback)
    }

    this.getChildAndIntermediateCompounds = function(parents)
    {
	var resp = json_call_ajax_sync(_url,"Experiment.getChildAndIntermediateCompounds", [parents]);
//	var resp = json_call_sync("Experiment.getChildAndIntermediateCompounds", [parents]);
        return resp[0];
    }

    this.getChildAndIntermediateCompounds_async = function(parents, _callback, _error_callback)
    {
	json_call_ajax_async(_url,"Experiment.getChildAndIntermediateCompounds", [parents], 1, _callback, _error_callback)
    }

    this.getParentAndIntermediateCompounds = function(children)
    {
	var resp = json_call_ajax_sync(_url,"Experiment.getParentAndIntermediateCompounds", [children]);
//	var resp = json_call_sync("Experiment.getParentAndIntermediateCompounds", [children]);
        return resp[0];
    }

    this.getParentAndIntermediateCompounds_async = function(children, _callback, _error_callback)
    {
	json_call_ajax_async(_url,"Experiment.getParentAndIntermediateCompounds", [children], 1, _callback, _error_callback)
    }

    this.findMedias = function(exclude_medias, exclude_compounds, exclude_solid, exclude_undefined)
    {
	var resp = json_call_ajax_sync(_url,"Experiment.findMedias", [exclude_medias, exclude_compounds, exclude_solid, exclude_undefined]);
//	var resp = json_call_sync("Experiment.findMedias", [exclude_medias, exclude_compounds, exclude_solid, exclude_undefined]);
        return resp[0];
    }

    this.findMedias_async = function(exclude_medias, exclude_compounds, exclude_solid, exclude_undefined, _callback, _error_callback)
    {
	json_call_ajax_async(_url,"Experiment.findMedias", [exclude_medias, exclude_compounds, exclude_solid, exclude_undefined], 1, _callback, _error_callback)
    }

    this.findStrainsAndKOs = function(genome_id, maxKnockouts, onlyWildtype, onlyAggregate)
    {
	var resp = json_call_ajax_sync(_url,"Experiment.findStrainsAndKOs", [genome_id, maxKnockouts, onlyWildtype, onlyAggregate]);
//	var resp = json_call_sync("Experiment.findStrainsAndKOs", [genome_id, maxKnockouts, onlyWildtype, onlyAggregate]);
        return resp[0];
    }

    this.findStrainsAndKOs_async = function(genome_id, maxKnockouts, onlyWildtype, onlyAggregate, _callback, _error_callback)
    {
	json_call_ajax_async(_url,"Experiment.findStrainsAndKOs", [genome_id, maxKnockouts, onlyWildtype, onlyAggregate], 1, _callback, _error_callback)
    }

    this.generateGrowmatchInput = function(gmInputParams)
    {
	var resp = json_call_ajax_sync(_url,"Experiment.generateGrowmatchInput", [gmInputParams]);
//	var resp = json_call_sync("Experiment.generateGrowmatchInput", [gmInputParams]);
        return resp[0];
    }

    this.generateGrowmatchInput_async = function(gmInputParams, _callback, _error_callback)
    {
	json_call_ajax_async(_url,"Experiment.generateGrowmatchInput", [gmInputParams], 1, _callback, _error_callback)
    }

    this.generateAndStoreGMInput = function(gmInputParams, workspace_id, object_id)
    {
	var resp = json_call_ajax_sync(_url,"Experiment.generateAndStoreGMInput", [gmInputParams, workspace_id, object_id]);
//	var resp = json_call_sync("Experiment.generateAndStoreGMInput", [gmInputParams, workspace_id, object_id]);
        return resp;
    }

    this.generateAndStoreGMInput_async = function(gmInputParams, workspace_id, object_id, _callback, _error_callback)
    {
	json_call_ajax_async(_url,"Experiment.generateAndStoreGMInput", [gmInputParams, workspace_id, object_id], 0, _callback, _error_callback)
    }
